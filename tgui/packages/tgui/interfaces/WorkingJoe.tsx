...
const Login = (props) => {
  ...
  return (
    ...
    >
      ...
      <Box fontFamily="monospace">Все права защищены © 2182, Вейланд-Ютани Корп.</Box>
        ...
        <Flex align="center">
          <Box>
            ...
            <Button
              ...
              ml="auto"
              mr="1rem"
              tooltip={soundicon == "volume-high" ? "Включить звук уведомлений" : "Выключить звук уведомлений"}
    ...
    <>
      ...
      <Section>
        ...
        {maintenance_tickets.map((ticket, i) => {
          ...
          let can_cancel = true;
          if (ticket.submitter !== local_logged_in || ticket.lock_status === 'CLOSED') {
            can_cancel = false;
          }
...
const MaintManagement = (props) => {
  ...
  return (
    <>
      ...
      <Section>
        <h1 style={{ textAlign: 'center' }}>Управление заявками на обслуживание</h1>
      ...
      <Section>
        ...
        {access_tickets.map((ticket, i) => {
          ...
          if (ticket.status === 'rejected') {
            view_status = 'Заявка отклонена.';
            view_icon = 'circle-xmark';
            update_tooltip = 'Заявка была отклонена. Это окончательное решение.';
          } else if (ticket.status === 'cancelled') {
            view_status = 'Заявка отменена.';
            view_icon = 'circle-stop';
...
const CoreSecGas = (props) => {
  ...
  return (
    <>
      ...
      <Section>
        <h1 style={{ textAlign: 'center' }}>Выброс нервно-паралитического газа</h1>
