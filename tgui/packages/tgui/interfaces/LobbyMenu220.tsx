      ...
      >
        <Box>
          ...
          <Stack justify="center">
            <Stack.Item>
              <Button onClick={() => act('confirm')}>Подтвердить</Button>
            </Stack.Item>
          </Stack>
        </Box>
      </Section>,
      ...
      >
        ...
        >
                      ...
                      <Stack>
                        <Stack.Item>
                          <Button
                            ...
                            tooltip="Выключает CRT-фильтр фона"
                          >
                            {`${filterDisabled ? 'Включить' : 'Выключить'} режим кино`}
                          </Button>
                        </Stack.Item>
                        <Stack.Item>
                          <Button
                            ...
                            tooltip="Полностью отключает CRT тему, в том числе и фильтр"
                          >
                            {`${themeDisabled ? 'Включить' : 'Выключить'} CRT тему`}
                          </Button>
                        </Stack.Item>
                      </Stack>
                    </Section>
          ...
          <Box className="bgLoad authorAttrib styledText">
            {lobby_author ? `Автор арта: ${lobby_author}` : ''}
          </Box>
        </LobbyContext.Provider>
      </Window.Content>
    </Window>
    ...
    >
      <Stack vertical>
            ...
            <Stack.Item minWidth="200px">
              <Stack vertical>
                <Stack.Item>
                  <Stack justify="center">
                    <Stack.Item>
                      <Box className="typeEffect styledText">Приветствую,</Box>
                    </Stack.Item>
                  </Stack>
                </Stack.Item>
                <Stack.Item>
        ...
        <LobbyButton
          ...
          tooltip={
            !tutorials_ready
              ? 'Обучения могут быть запущены лишь во время активной игры.'
              : ''
          }
          icon="book-open"
        >
              ...
              <ModalConfirm>
                <Box>
                  <Stack vertical>
                    ...
                    <Stack.Item>
                      Вы больше не сможете присоединиться к игре на стороне
                      морпехов.
                    </Stack.Item>
                    <Stack.Item>
                      Вы сможете сможете присоединиться к Чужим лишь через
                      некоторое время.
                    </Stack.Item>
                  </Stack>
                  <Stack justify="center">
        ...
        {round_start ? (
          <Stack.Item>
            <LobbyButton
              ...
              tooltip={
                xenomorph_enabled ? 'Готов со включенными Чужими' : undefined
              }
            >
              {readied ? 'Не готов' : 'Готов'}
            </LobbyButton>
          </Stack.Item>
        ) : (
          <>
              ...
              <Stack>
                <Stack.Item grow>
                  <LobbyButton
                    ...
                    icon="users"
                  >
                    Присоединиться к ККМП
                  </LobbyButton>
                </Stack.Item>
                <Stack.Item>
                  <LobbyButton
                    icon="list"
                    tooltip="Посмотреть манифест экипажа"
                    index={8}
            ...
            <Stack.Item>
              <Stack>
                ...
                <Stack.Item>
                  <LobbyButton
                    icon="users-rays"
                    tooltip="Посмотреть лидеров Улья"
                    index={9}
              ...
              <Stack.Item>
                    ...
                    setModal(
                      <ModalConfirm>
                        <Box>
                          <Stack vertical>
                            <Stack.Item>
                              Вы уверены что хотите присоединиться к Хищникам?
                            </Stack.Item>
                          </Stack>
                          <Stack justify="center">
                            <Stack.Item>
                ...
                >
                  <Flex>
                    ...
                    <Flex.Item>Присоединиться к охоте</Flex.Item>
                  </Flex>
                </LobbyButton>
              </Stack.Item>
            )}
                    ...
                    setModal(
                      <ModalConfirm>
                        <Box>
                          <Stack vertical>
                            <Stack.Item>
                              Вы уверены что хотите зайти за ответчика на факсы?
                            </Stack.Item>
                          </Stack>
                          <Stack justify="center">
                            <Stack.Item>
