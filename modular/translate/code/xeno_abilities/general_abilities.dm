...
/datum/action/xeno_action/activable/pounce
	desc = "Позволяет наброситься на клетку, с возможностью опрокинуть цель."
...
/datum/action/xeno_action/activable/tail_stab
	desc = "Удар хвостом на расстоянии 2-х клеток, который наносит на 20% больше урона, а также дезориентирирует цель."
...
/datum/action/xeno_action/onclick/tacmap
	desc = "Тактическая карта с двумя режимами - режимом прямого эфира с текущим положением систер, а также режим планирования, где Королева может рисовать."
