...
/datum/roundstart_spawn/motorbike
	object_to_spawn = /obj/vehicle/motorbike/camo/full
	min_spawns = 1
	max_spawns = 3
	range = 1
	required_players = 60
...
/datum/roundstart_spawn/motorbike/intel
	object_to_spawn = /obj/vehicle/motorbike/camo // Без коляски
	attached_to_type = /obj/effect/landmark/start/intel

/datum/roundstart_spawn/motorbike/mp
	object_to_spawn = /obj/vehicle/motorbike/urban/full	// Городской
...
/datum/roundstart_spawn/motorbike/crc
	object_to_spawn = /obj/vehicle/motorbike/urban // Без коляски, городской
