...
/datum/job/civilian/field_doctor
	...
	entry_message_body = "Вы <a href='"+WIKI_PLACEHOLDER+"'>полевой врач</a> , которому поручено поддерживать морских пехотинцев в полевых условиях, обычно в виде хирургических операций. Вы должны оставаться на борту медицинского отсека «Альмайера», если там нет других врачей, и пока не будет обеспечена безопасность ФОБ. Ваше начальство также может задержать ваше отправление в поле."
