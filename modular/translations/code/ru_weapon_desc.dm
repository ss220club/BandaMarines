...
/obj/item/weapon/gun/smg/m39
	desc = "Пистолет-пулемёт Armat Battlefield Systems M-39. Иногда используется легкой пехотой, разведчиками, инженерами и медиками. В качестве легкой и малокалиберной альтернативы различным видам импульсного оружия используется USCM. Стреляет патронами размером 10х20 мм из магазина на 48 патронов."
