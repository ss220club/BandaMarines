/obj/item/weapon/gun/rifle/bolter
	...
	icon = 'modular/weapons/icons/bolter/bolter.dmi'
	icon_state = "bolter"
	item_state = "bolter"
	item_icons = list(
		...
		WEAR_L_HAND = 'modular/weapons/icons/bolter/lefthand.dmi',
		WEAR_R_HAND = 'modular/weapons/icons/bolter/righthand.dmi'
	)
	muzzle_flash = "muzzle_laser"
	muzzle_flash_color = COLOR_LASER_RED
	gun_category = GUN_CATEGORY_RIFLE
	flags_equip_slot = SLOT_WAIST
	fire_sound = 'modular/weapons/sounds/bolter3.ogg'
...
/obj/item/ammo_magazine/rifle/bolter
	...
	caliber = ".75"
	icon = 'modular/weapons/icons/bolter/ammo.dmi'
	icon_state = "bolter"
