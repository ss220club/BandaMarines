/obj/item/weapon/gun/rifle/lasgun
	...
	icon = 'modular/weapons/icons/lasgun/lasgun.dmi'
	icon_state = "lasgun"
	item_state = "lasgun"
	item_icons = list(
		...
		WEAR_L_HAND = 'modular/weapons/icons/lasgun/lefthand.dmi',
		WEAR_R_HAND = 'modular/weapons/icons/lasgun/righthand.dmi'
	)
	muzzle_flash = "muzzle_laser"
	muzzle_flash_color = COLOR_LASER_RED
	gun_category = GUN_CATEGORY_RIFLE
	flags_equip_slot = SLOT_WAIST
	fire_sound = 'modular/weapons/sounds/lasgun1.ogg'
...
/obj/item/ammo_magazine/rifle/lasgun
	...
	caliber = "LAS"
	icon = 'modular/weapons/icons/lasgun/ammo.dmi'
	icon_state = "las"
...
/obj/item/ammo_magazine/rifle/lasgun/extended
	...
	max_rounds = 60
	bonus_overlay_icon = 'modular/weapons/icons/lasgun/ammo.dmi'
	bonus_overlay = "las_ex"

/datum/ammo/energy/lasgun
	name = "laser bolt"
	icon = 'modular/weapons/icons/projectiles2.dmi'
	icon_state = "lasbolt"
