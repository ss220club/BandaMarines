...
/datum/equipment_preset/survivor/roaf/proc/equip_common_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/clothing/shoes/marine/lv733/shoes_roaf(new_human), WEAR_FEET)
	...
	new_human.equip_to_slot_or_del(new /obj/item/clothing/gloves/marine/veteran/lv733/hands_roaf(new_human), WEAR_HANDS)
...
/datum/equipment_preset/survivor/roaf/proc/equip_roaf_uniform(mob/living/carbon/human/new_human)
	var/obj/item/clothing/under/lv733/roaf_sniper/uniform = new()
	if(prob(50))
...
/datum/equipment_preset/survivor/roaf/load_gear(mob/living/carbon/human/new_human)
	equip_roaf_uniform(new_human)
	equip_common_gear(new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/head/lv733/roaf_beret(new_human), WEAR_HEAD)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest/lv733/suit_roaf(new_human), WEAR_JACKET)
...
/datum/equipment_preset/survivor/roaf/engi/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/clothing/head/lv733/roaf_boonie(new_human), WEAR_HEAD)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/lv733/roaf_support(new_human), WEAR_BODY)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest/lv733/suit_roaf(new_human), WEAR_JACKET)
	new_human.equip_to_slot_or_del(new /obj/item/tool/crowbar/tactical(new_human), WEAR_IN_JACKET)
...
/datum/equipment_preset/survivor/roaf/pilot/load_gear(mob/living/carbon/human/new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/head/lv733/roaf_pilot_hat(new_human), WEAR_HEAD)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/lv733/roaf_pilot(new_human), WEAR_BODY)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest/lv733/suit_roaf_pilot(new_human), WEAR_JACKET)
	new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/smg/p90/twe(new_human), WEAR_J_STORE)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/p90/ap(new_human), WEAR_IN_JACKET)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/p90/ap(new_human), WEAR_IN_JACKET)
	new_human.equip_to_slot_or_del(new /obj/item/storage/backpack/lightpack/five_slot(new_human), WEAR_BACK)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/shoes/marine/lv733/shoes_roaf_pilot(new_human), WEAR_FEET)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/gloves/marine/veteran/lv733/hands_roaf(new_human), WEAR_HANDS)
	new_human.equip_to_slot_or_del(new /obj/item/device/radio/headset/distress/roaf(new_human), WEAR_L_EAR)
...
/datum/equipment_preset/survivor/roaf/sniper/load_gear(mob/living/carbon/human/new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/lv733/roaf_sniper(new_human), WEAR_BODY)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest/lv733/suit_roaf(new_human), WEAR_JACKET)
...
/datum/equipment_preset/survivor/roaf/squad_leader/load_gear(mob/living/carbon/human/new_human)
	equip_common_gear(new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/lv733/roaf_uniform(new_human), WEAR_BODY)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/head/lv733/roaf_beret(new_human), WEAR_HEAD)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest/lv733/suit_roaf(new_human), WEAR_JACKET)
	new_human.equip_to_slot_or_del(new /obj/item/tool/crowbar/tactical(new_human), WEAR_IN_JACKET)
	new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/rifle/rmc_f90(new_human), WEAR_J_STORE)
...
/datum/equipment_preset/synth/survivor/roaf_synth/load_gear(mob/living/carbon/human/new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/lv733/roaf_shooter(new_human), WEAR_BODY)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/accessory/storage/webbing/iasf(new_human), WEAR_ACCESSORY)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/head/lv733/roaf_shooter_helmet(new_human), WEAR_HEAD)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest/lv733/suit_roaf_shooter(new_human), WEAR_JACKET)
...
/datum/equipment_preset/survivor/whitchler/roaf_commander/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/clothing/gloves/marine/veteran/lv733/hands_roaf(new_human), WEAR_HANDS)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/lv733/roaf_officer(new_human), WEAR_BODY)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest/lv733/suit_roaf_pilot(new_human), WEAR_JACKET)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/shoes/marine/lv733/shoes_roaf_pilot(new_human), WEAR_FEET)
	new_human.equip_to_slot_or_del(new /obj/item/device/radio/headset/distress/roaf(new_human), WEAR_L_EAR)
