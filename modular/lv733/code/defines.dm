...
#define JOB_TWE_ROAF_SIGNALLER "ROAF Signaller"
...
#define JOB_TWE_RAF_SIGNALLER JOB_TWE_ROAF_SIGNALLER
#define JOB_TWE_RAF_SYNTH JOB_TWE_ROAF_SYNTH

#define PROB_WEATHER_LV733 60
...
/datum/paygrade/twe/roaf/s1
	...
	name = "Сержант лётного обеспечения"
	prefix = "С-т лёт. обесп."
