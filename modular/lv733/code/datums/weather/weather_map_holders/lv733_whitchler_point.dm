/datum/weather_ss_map_holder/lv733_whitchler_point
	name = "LV-733 Whitchler Point Map Holder"
	...
	potential_weather_events = list(
		/datum/weather_event/lv733/blizzard,
	)
...
/datum/weather_ss_map_holder/lv733_whitchler_point/should_start_event()
	return prob(PROB_WEATHER_LV733)
