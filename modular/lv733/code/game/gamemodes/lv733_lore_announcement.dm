...
/datum/game_mode/proc/lore_announcement_lv733()
	...
	addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(xeno_announcement), "Дети мои. Я ощущаю усталость их воинов. Их движения стали медленнее. Их решения — хуже, держитесь сделайте эту колонию нашим гнездом.", "everything", QUEEN_MOTHER_ANNOUNCE), 80 MINUTES)
