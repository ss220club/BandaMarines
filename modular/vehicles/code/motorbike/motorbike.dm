/obj/vehicle/motorbike
	...
	//========= Прочие параметры ============
	density = FALSE // Байк не влияет на толщину, мобы внутри влияют
	...
	var/create_sidecar = NO_SIDECAR //Проверка на коляску при создании. 0 - никакая, 1 - пассажирская, 2 - грузовая и т.д.
