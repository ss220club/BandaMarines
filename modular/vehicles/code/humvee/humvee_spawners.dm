...
/obj/effect/vehicle_spawner/humvee/spawn_vehicle()
	var/obj/vehicle/multitile/modular/humvee/HUMVEE = new (loc)
...
/obj/effect/vehicle_spawner/humvee/medical/spawn_vehicle()
	var/obj/vehicle/multitile/modular/humvee/medical/HUMVEE_MED = new (loc)
...
/obj/effect/vehicle_spawner/humvee/transport/spawn_vehicle()
	var/obj/vehicle/multitile/modular/humvee/transport/HUMVEE_TRANSPORT = new (loc)
...
/obj/effect/vehicle_spawner/humvee/apc/spawn_vehicle()
	var/obj/vehicle/multitile/modular/humvee/apc/HUMVEE_APC = new (loc)
