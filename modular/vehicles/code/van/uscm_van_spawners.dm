...
/obj/effect/vehicle_spawner/uscm_van/spawn_vehicle()
	var/obj/vehicle/multitile/modular/uscm_van/VAN = new (loc)
...
/obj/effect/vehicle_spawner/uscm_van/decrepit/load_hardpoints(obj/vehicle/multitile/modular/uscm_van/V)
...
/obj/effect/vehicle_spawner/uscm_van/fixed/load_hardpoints(obj/vehicle/multitile/modular/uscm_van/V)
	V.add_hardpoint(new /obj/item/hardpoint/locomotion/van_wheels)
...
/obj/effect/vehicle_spawner/uscm_van/med/spawn_vehicle()
	var/obj/vehicle/multitile/modular/uscm_van/med/MED_VAN = new (loc)
...
/obj/effect/vehicle_spawner/uscm_van/med/decrepit/load_hardpoints(obj/vehicle/multitile/modular/uscm_van/med/V)
	V.add_hardpoint(new /obj/item/hardpoint/locomotion/van_wheels)
...
/obj/effect/vehicle_spawner/uscm_van/med/fixed/load_hardpoints(obj/vehicle/multitile/modular/uscm_van/med/V)
	V.add_hardpoint(new /obj/item/hardpoint/locomotion/van_wheels)
