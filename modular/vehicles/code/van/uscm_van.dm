/obj/vehicle/multitile/modular/uscm_van
	name = "\improper Грузовой фургон M35-T"
	...
	interior_map = /datum/map_template/interior/modular/uscm_van
...
/obj/vehicle/multitile/modular/uscm_van/Initialize()
	. = ..()
...
/obj/vehicle/multitile/modular/uscm_van/crew_mousedown(datum/source, atom/object, turf/location, control, params)
...
/obj/vehicle/multitile/modular/uscm_van/BlockedPassDirs(atom/movable/mover, target_dir)
...
** PRESETS
*/
/obj/vehicle/multitile/modular/uscm_van/pre_movement()
...
/obj/vehicle/multitile/modular/uscm_van/proc/add_under_van(mob/living/living)
...
/obj/vehicle/multitile/modular/uscm_van/proc/remove_under_van(mob/living/living)
	SIGNAL_HANDLER
	mobs_under -= living
...
/obj/vehicle/multitile/modular/uscm_van/proc/check_under_van(mob/mob, turf/oldloc, direction)
	SIGNAL_HANDLER
	if(!(mob.loc in locs))
		remove_under_van(mob)

/obj/vehicle/multitile/modular/uscm_van/proc/add_client(mob/living/living)
	SIGNAL_HANDLER
	living.client.images += under_image
	living.client.images -= normal_image

/obj/vehicle/multitile/modular/uscm_van/proc/add_default_image(subsystem, mob/mob)
	SIGNAL_HANDLER
	mob.client.images += normal_image

/obj/vehicle/multitile/modular/uscm_van/Destroy()
	for(var/icon in mobs_under)
...
/obj/vehicle/multitile/modular/uscm_van/attackby(obj/item/O, mob/user)
	if(user.z != z)
		return ..()
...
/obj/vehicle/multitile/modular/uscm_van/handle_click(mob/living/user, atom/A, list/mods)
...
/obj/vehicle/multitile/modular/uscm_van/proc/reset_overdrive()
	misc_multipliers["move"] += overdrive_speed_mult

/obj/vehicle/multitile/modular/uscm_van/get_projectile_hit_boolean(obj/projectile/P)
...
/obj/vehicle/multitile/modular/uscm_van/Collide(atom/A)
