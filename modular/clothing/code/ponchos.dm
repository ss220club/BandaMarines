/obj/item/clothing/accessory/poncho/white
	icon = 'modular/clothing/accessory/ponchos.dmi'
	icon_state = "w_poncho"
	inv_overlay_icon = 'modular/clothing/accessory/inventory_overlays/ponchos.dmi'
...
/obj/item/clothing/accessory/cape/twe_cape
	name = "torn TWE flag"
	desc = "A torn up TWE flag with a pin that allows it to be worn as a cape."
	icon_state = "twe_cape"
	item_state = "twe_cape"
