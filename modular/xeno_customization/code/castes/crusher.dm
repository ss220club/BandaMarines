/datum/xeno_customization_option/crusher_rhino
	name = "(Крушитель) Носорог"
	key = "crusher_rhino"
	customization_type = XENO_CUSTOMIZATION_NON_LORE_FRIENDLY
	icon_path = 'modular/xeno_customization/icons/crusher/rhino_full.dmi'
	subtract_icon_path = 'modular/xeno_customization/icons/crusher/crusher_substract.dmi'
