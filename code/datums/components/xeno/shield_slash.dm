...
/datum/component/shield_slash/proc/handle_shield_buildup(mob/living/carbon/xenomorph/X)
	...
	X.visible_message(SPAN_XENOWARNING("$1 roars as it mauls its target, its exoskeleton shimmering for a second!", list(X)), SPAN_XENOHIGHDANGER("You feel your rage increase your resiliency to damage!")) // SS220 EDIT ADDICTION
