...
/datum/emergency_call/pmc/New()
	...
	objectives = "Окажите поддержку экипажу судна [MAIN_SHIP_NAME]. Обеспечьте безопасность корпоративного связного и командующего офицера, и устраните все враждебные угрозы."
