...
/datum/emergency_call/contractors/New()
	..()
	arrival_message = "[MAIN_SHIP_NAME], это ККС \"Наследник\" с \"Стрела Авангарда\", Приоритетная задача; мы получили ваш сигнал бедствия и выдвигаемся к вам в соответствии с Законом о военной помощи от 2177 года, код аутентификации Лима-18153."
...
/datum/emergency_call/contractors/covert/New()
	..()
	arrival_message = "[MAIN_SHIP_NAME], это ККС \"Наследник\" с \"Стрела Авангарда\", Приоритетная задача; мы получили ваш сигнал бедствия и выдвигаемся к вам в соответствии с Законом о военной помощи от 2177 года, код аутентификации Икс-Рей 19601."
