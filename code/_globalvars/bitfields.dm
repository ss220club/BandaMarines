...
//how would you even access this in vv but here anyways
DEFINE_BITFIELD(reaction_type, list(
...
DEFINE_BITFIELD(flags_gun_features, list(
	...
	"GUN_BATTLEFIELD_EXECUTION" = GUN_BATTLEFIELD_EXECUTION,
	"GUN_TRICKSTER" = GUN_TRICKSTER,
	"GUN_CAN_WARNING_SHOT" = GUN_CAN_WARNING_SHOT,
))
...
DEFINE_BITFIELD(flags_atom, list(
	...
	"HTML_USE_INITIAL_ICON" = HTML_USE_INITIAL_ICON,
	"QUICK_DRAWABLE" = QUICK_DRAWABLE,
	"MAP_COLOR_INDEX" = MAP_COLOR_INDEX,
	"NO_ZFALL" = NO_ZFALL,
	"BUMP_ATTACKABLE" = BUMP_ATTACKABLE, // BANDASTATION EDIT - Bump Attacks
))
...
DEFINE_BITFIELD(flags_item, list(
	...
	"CAN_BUMP_ATTACK" = CAN_BUMP_ATTACK,  // BANDASTATION EDIT - Bump Attacks
))
...
DEFINE_BITFIELD(storage_flags, list(
	...
	"STORAGE_GATHER_SIMULTANEOUSLY" = STORAGE_GATHER_SIMULTANEOUSLY,
...
DEFINE_BITFIELD(mob_flags, list(
	...
	"GIVING" = GIVING,
	"NOBIOSCAN" = NOBIOSCAN,
	"MUTINY_MUTINEER" = MUTINY_MUTINEER,
	"MUTINY_LOYALIST" = MUTINY_LOYALIST,
	"MUTINY_NONCOMBAT" = MUTINY_NONCOMBAT,
	"MOB_ABSTRACT" = MOB_ABSTRACT
))
...
DEFINE_BITFIELD(flags_round_type, list(
	...
	"MODE_COLONY_JOE" = MODE_COLONY_JOE,
...
DEFINE_BITFIELD(flags_obj, list(
	...
	"OBJ_IS_STYLISH" = OBJ_IS_STYLISH,
	"OBJ_CAN_ACCESSORIZE" = OBJ_CAN_ACCESSORIZE,
...
DEFINE_BITFIELD(fire_immunity, list(
	...
	"FIRE_IMMUNITY_IGNORE_PEN" = FIRE_IMMUNITY_IGNORE_PEN,
))
...
#define pass_flags_list list(\
	...
	"PASS_ACID_GRENADE" = PASS_ACID_GRENADE,\
)
DEFINE_BITFIELD(flags_pass, pass_flags_list)
DEFINE_BITFIELD(flags_can_pass_all, pass_flags_list)
DEFINE_BITFIELD(flags_can_pass_front, pass_flags_list)
DEFINE_BITFIELD(flags_can_pass_behind, pass_flags_list)
DEFINE_BITFIELD(flags_pass_temp, pass_flags_list)
DEFINE_BITFIELD(flags_can_pass_all_temp, pass_flags_list)
DEFINE_BITFIELD(flags_can_pass_front_temp, pass_flags_list)
DEFINE_BITFIELD(flags_can_pass_behind_temp, pass_flags_list)
#undef pass_flags_list

#define sight_flags_list list(\
	"BLIND" = BLIND,\
...
DEFINE_BITFIELD(sight, sight_flags_list)
DEFINE_BITFIELD(vision_flags, sight_flags_list)
#undef sight_flags_list
...
DEFINE_BITFIELD(hive_flags, list(
	"XENO_SLASH_NORMAL" = XENO_SLASH_NORMAL,
	"XENO_SLASH_INFECTED" = XENO_SLASH_INFECTED,
	"XENO_UNNESTING_RESTRICTED" = XENO_UNNESTING_RESTRICTED,
	"XENO_CONSTRUCTION_NORMAL" = XENO_CONSTRUCTION_NORMAL,
	"XENO_CONSTRUCTION_LEADERS" = XENO_CONSTRUCTION_LEADERS,
	"XENO_CONSTRUCTION_QUEEN" = XENO_CONSTRUCTION_QUEEN,
	"XENO_DECONSTRUCTION_NORMAL" = XENO_DECONSTRUCTION_NORMAL,
	"XENO_DECONSTRUCTION_LEADERS" = XENO_DECONSTRUCTION_LEADERS,
	"XENO_DECONSTRUCTION_QUEEN" = XENO_DECONSTRUCTION_QUEEN,
))

DEFINE_BITFIELD(shield_flags, list(
	"CAN_SHIELD_BASH" = CAN_SHIELD_BASH,
	"CAN_BLOCK_POUNCE" = CAN_BLOCK_POUNCE,
	"CAN_BLOCK_HEAVY" = CAN_BLOCK_HEAVY,
))
...
DEFINE_BITFIELD(ride_check_flags, list(
	"RIDER_NEEDS_ARMS" = RIDER_NEEDS_ARMS,
	"RIDER_NEEDS_ARM" = RIDER_NEEDS_ARM,
	"RIDER_NEEDS_LEGS" = RIDER_NEEDS_LEGS,
	"UNBUCKLE_DISABLED_RIDER " = UNBUCKLE_DISABLED_RIDER,
	"CARRIER_NEEDS_ARM" = CARRIER_NEEDS_ARM

))

DEFINE_BITFIELD(insert_flags, list(
	"PLAY_INSERT_STANDARD" = PLAY_INSERT_STANDARD,
	"PLAY_INSERT_CORPORATE" = PLAY_INSERT_CORPORATE,
	"PLAY_INSERT_LEADER" = PLAY_INSERT_LEADER,
	"PLAY_INSERT_MEDIC " = PLAY_INSERT_MEDIC,
	"PLAY_INSERT_ENGINEER" = PLAY_INSERT_ENGINEER,
	"PLAY_INSERT_SPECIALIST" = PLAY_INSERT_SPECIALIST,
	"PLAY_INSERT_SMARTGUNNER" = PLAY_INSERT_SMARTGUNNER,
	"PLAY_INSERT_SYNTH" = PLAY_INSERT_SYNTH,
	"PLAY_INSERT_CO" = PLAY_INSERT_CO
))

DEFINE_BITFIELD(xeno_organ_flags, list(
	"XENO_ORGAN_PLASMA" = XENO_ORGAN_PLASMA,
	"XENO_ORGAN_FRESH" = XENO_ORGAN_FRESH,
	"XENO_ORGAN_ACID" = XENO_ORGAN_ACID,
	"XENO_ORGAN_SUPPORT" = XENO_ORGAN_SUPPORT,
	"XENO_ORGAN_HARDENED" = XENO_ORGAN_HARDENED,
	"XENO_ORGAN_TACHYCARDIA" = XENO_ORGAN_TACHYCARDIA,
	"XENO_ORGAN_FRAGILE" = XENO_ORGAN_FRAGILE,
	"XENO_ORGAN_WEAK" = XENO_ORGAN_WEAK,
	"XENO_ORGAN_STRONG" = XENO_ORGAN_STRONG,
	"XENO_ORGAN_ROYAL" = XENO_ORGAN_ROYAL
))
