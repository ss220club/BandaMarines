...
DEFINE_BITFIELD(flags_attach_features, list(
	...
	"ATTACH_IGNORE_EMPTY" = ATTACH_IGNORE_EMPTY,
	"ATTACH_MELEE" = ATTACH_MELEE,
	"ATTACH_WIELD_OVERRIDE" = ATTACH_WIELD_OVERRIDE,
))
