...
#define XENO_CASTE_BEHEMOTH    "Behemoth"
#define XENO_T2_CASTES    list(XENO_CASTE_BURROWER, XENO_CASTE_BEHEMOTH, XENO_CASTE_CARRIER, XENO_CASTE_HIVELORD, XENO_CASTE_LURKER, XENO_CASTE_WARRIOR, XENO_CASTE_SPITTER)
//t3
