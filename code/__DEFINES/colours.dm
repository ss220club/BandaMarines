...
#define DISCORD_EMBED_COLOR_BAN_PERMANENT 0xED4245
#define DISCORD_EMBED_COLOR_BAN_TIMED 0xF0B232
#define DISCORD_EMBED_COLOR_BAN_JOB 0x5865F2
#define DISCORD_EMBED_COLOR_BAN_JOB_PERMANENT 0x9B59B6
