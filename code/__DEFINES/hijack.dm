...
#define HIJACK_OBJECTIVES_STARTED 2
#define HIJACK_OBJECTIVES_GROUND_CRASH 3
#define HIJACK_OBJECTIVES_FTL_CRASH 4
#define HIJACK_OBJECTIVES_COMPLETE 5
#define HIJACK_OBJECTIVES_DOCKED 6
