...
GLOBAL_LIST_INIT(ROLES_CIC_ANTAG, list(JOB_UPP_CO_OFFICER, JOB_UPP_KPT_OFFICER, JOB_UPP_SRLT_OFFICER))
GLOBAL_LIST_INIT(ROLES_AUXIL_SUPPORT, list(JOB_AUXILIARY_OFFICER, JOB_SEA, JOB_INTEL, JOB_CAS_PILOT, JOB_DROPSHIP_PILOT, JOB_DROPSHIP_CREW_CHIEF, JOB_TANK_CREW, JOB_WO_CHIEF_POLICE, JOB_WO_SO, JOB_WO_WARDEN, JOB_WO_POLICE, JOB_WO_PILOT, JOB_SYNTH_INTEL))
GLOBAL_LIST_INIT(ROLES_AUXIL_SUPPORT_ANTAG, list(JOB_UPP_COMMISSAR, JOB_UPP_CREWMAN, JOB_UPP_PILOT))
...
GLOBAL_LIST_INIT(ROLES_POLICE, list(JOB_CHIEF_POLICE, JOB_WARDEN, JOB_POLICE, JOB_POLICE_HG, JOB_SYNTH_MP))
GLOBAL_LIST_INIT(ROLES_POLICE_ANTAG, list(JOB_UPP_POLICE))
GLOBAL_LIST_INIT(ROLES_ENGINEERING, list(JOB_CHIEF_ENGINEER, JOB_MAINT_TECH, JOB_WO_CHIEF_ENGINEER, JOB_WO_ORDNANCE_TECH, JOB_SYNTH_ENG))
...
GLOBAL_LIST_INIT(ROLES_MEDICAL_ANTAG, list(JOB_UPP_LT_DOKTOR)) // JOB_UPP_SCIENCE
...
GLOBAL_LIST_INIT(ROLES_MARINES_ANTAG, list(JOB_UPP_LEADER, JOB_UPP_SPECIALIST, JOB_UPP_ENGI, JOB_UPP_MEDIC, JOB_UPP))
...
GLOBAL_LIST_INIT(ROLES_UPP_SQUAD_ALL, list(SQUAD_UPP_1, SQUAD_UPP_2, SQUAD_UPP_3, SQUAD_UPP_4, SQUAD_UPP_5))
...
GLOBAL_LIST_INIT(ROLES_WHITELISTED, list(JOB_SYNTH_SURVIVOR, JOB_CO_SURVIVOR, JOB_PREDATOR, JOB_PRED_SURVIVOR, JOB_FAX_RESPONDER))
...
#define FACTION_YAUTJA_STRANDED "Yautja Stranded"
#define FACTION_YAUTJA_BADBLOOD "Yautja Badblood"
#define FACTION_BLOODED_HUNTER "Blooded Hunter"
#define FACTION_MILITARY_CASTE "Yautja Military Caste"
...
#define FACTION_LIST_YAUTJA list(FACTION_YAUTJA, FACTION_YAUTJA_YOUNG, FACTION_BLOODED_HUNTER, FACTION_MILITARY_CASTE)//For faction grouping
#define FACTION_LIST_ALL_YAUTJA list(FACTION_YAUTJA, FACTION_YAUTJA_YOUNG, FACTION_BLOODED_HUNTER, FACTION_MILITARY_CASTE, FACTION_YAUTJA_STRANDED, FACTION_YAUTJA_BADBLOOD)//For follow menu simplicity.
...
#define FACTION_XENOMORPH_BADBLOOD "Enthralled Hive"
