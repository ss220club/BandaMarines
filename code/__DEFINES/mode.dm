...
#define FACTION_LIST_TWE list(FACTION_TWE, FACTION_HUNTED_TWE, FACTION_IASF, FACTION_ROAF)
...
#define FACTION_LIST_SURVIVOR_ROAF list(FACTION_SURVIVOR, FACTION_ROAF, FACTION_TWE)
