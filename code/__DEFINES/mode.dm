...
#define FACTION_ROAF "Royal Orbital Air Force" // SS220 EDIT
...
#define FACTION_LIST_TWE list(FACTION_TWE, FACTION_IASF, FACTION_ROAF) // SS220 EDIT FACTION_ROAF
...
#define FACTION_LIST_SURVIVOR_ROAF list(FACTION_SURVIVOR, FACTION_ROAF, FACTION_TWE) // SS220 EDIT FACTION_ROAF
