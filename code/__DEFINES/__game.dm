...
#define WEAPON_DELAY_NO_EFFECT (1<<1)
#define WEAPON_DELAY_NO_FIRE (1<<2)
#define WEAPON_DELAY_SCATTER (1<<3)
#define WEAPON_DELAY_ACCURACY (1<<4)
#define WEAPON_DELAY_SCATTER_AND_ACCURACY (WEAPON_DELAY_SCATTER|WEAPON_DELAY_ACCURACY)
