...
#define AKULA_FREQ 1262
#define BIZON_FREQ 1263
#define CHAYKA_FREQ 1264
#define DELFIN_FREQ 1265
...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_AKULA = AKULA_FREQ,
	RADIO_CHANNEL_BIZON = BIZON_FREQ,
	RADIO_CHANNEL_CHAYKA = CHAYKA_FREQ,
	RADIO_CHANNEL_DELFIN = DELFIN_FREQ,
...
// UPP Frequencies
#define UPP_FREQS list(UPP_FREQ, UPP_CMD_FREQ, UPP_ENGI_FREQ, UPP_MED_FREQ, UPP_CCT_FREQ, UPP_KDO_FREQ, AKULA_FREQ, BIZON_FREQ, CHAYKA_FREQ, DELFIN_FREQ)
...
SUBSYSTEM_DEF(radio)
	...
	var/static/list/freq_to_span = list(
		...
		"[AKULA_FREQ]" = "akularadio",
		"[BIZON_FREQ]" = "bizonradio",
		"[CHAYKA_FREQ]" = "chaykaradio",
		"[DELFIN_FREQ]" = "delfinradio",
		"[ECHO_FREQ]" = "echoradio",
		"[CRYO_FREQ]" = "cryoradio",
		"[CBRN_FREQ]" = "hcradio",
