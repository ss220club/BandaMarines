...
/datum/controller/subsystem/weather/proc/start_weather_event()
	...
	if(!weather_event_instance)
		message_admins(SPAN_BLUE("Bad weather event of type $1.", list(weather_event_type), with_span_args=TRUE)) // SS220 EDIT ADDICTION
		return
	...
	if (weather_event_instance.display_name)
		message_admins(SPAN_BLUE("Weather Event of type $1 starting with duration of $2.", list(weather_event_instance.display_name, DisplayTimeText(weather_event_instance.length)), with_span_args=TRUE)) // SS220 EDIT ADDICTION
	else
		message_admins(SPAN_BLUE("Weather Event of unknown type $1 starting with duration of $2.", list(weather_event_type, DisplayTimeText(weather_event_instance.length)), with_span_args=TRUE)) // SS220 EDIT ADDICTION
...
/datum/controller/subsystem/weather/proc/end_weather_event()
	...
	if (weather_event_instance.display_name)
		message_admins(SPAN_BLUE("Weather Event of type $1 ending after $2.", list(weather_event_instance.display_name, DisplayTimeText(world.time - current_event_start_time)), with_span_args=TRUE)) // SS220 EDIT ADDICTION
	else
		message_admins(SPAN_BLUE("Weather Event of unknown type $1 ending after $2.", list(weather_event_type, DisplayTimeText(world.time - current_event_start_time)), with_span_args=TRUE)) // SS220 EDIT ADDICTION
