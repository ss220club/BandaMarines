...
/proc/get_access(access_list = ACCESS_LIST_GLOBAL)
	switch(access_list)
		...
		if(ACCESS_LIST_HYBRISA_KMCC_MANAGER)
			return list(ACCESS_HYBRISA_DYNAGRID_GENERAL,
			ACCESS_HYBRISA_DYNAGRID_GENERATORS,
			ACCESS_HYBRISA_DYNAGRID_GEAR,
			ACCESS_HYBRISA_DYNAGRID_CONTROL,
			ACCESS_HYBRISA_DYNAGRID_GAS,
			ACCESS_HYBRISA_DYNAGRID_TELECOMMS,
			ACCESS_HYBRISA_DYNAGRID_KITCHEN,
			ACCESS_HYBRISA_DEPARTURE,
			ACCESS_HYBRISA_MINING,
			ACCESS_HYBRISA_SUBSTATION_TWO,
			ACCESS_HYBRISA_HIGHMINING,
			ACCESS_HYBRISA_CARGO,
			ACCESS_HYBRISA_COMMAND,
			ACCESS_HYBRISA_DEPLOYMENT,
			ACCESS_HYBRISA_TOWER_KMCC,
			ACCESS_HYBRISA_SANITATION,
			ACCESS_HYBRISA_SYNTH,
			ACCESS_HYBRISA_SUBSTATION_THREE,
			ACCESS_HYBRISA_SUBSTATION_ONE,
			ACCESS_HYBRISA_MINING_NORTHEAST,
			ACCESS_HYBRISA_MINING_NORTH,
			ACCESS_HYBRISA_MINING_EAST,
			ACCESS_HYBRISA_WYFOYER,
			ACCESS_HYBRISA_WYOFFICE,
			ACCESS_HYBRISA_ASSEMBLY,
			ACCESS_HYBRISA_CONFERENCE,
			)

		if(ACCESS_LIST_HYBRISA_KMCC_MINER)
			return list(ACCESS_HYBRISA_MINING,
			ACCESS_HYBRISA_HIGHMINING,
			ACCESS_HYBRISA_DEPLOYMENT,
			ACCESS_HYBRISA_MINING_NORTHEAST,
			ACCESS_HYBRISA_MINING_NORTH,
		...
		if(ACCESS_LIST_HYBRISA_KMCC_ENGINEER)
			return list(ACCESS_HYBRISA_DYNAGRID_GENERAL,
			ACCESS_HYBRISA_DYNAGRID_GENERATORS,
			ACCESS_HYBRISA_DYNAGRID_GEAR,
			ACCESS_HYBRISA_DYNAGRID_GAS,
		...
		if(ACCESS_LIST_HYBRISA_SUBSTATIONS)
			return list(ACCESS_HYBRISA_SUBSTATION_ONE,
			ACCESS_HYBRISA_SUBSTATION_TWO,
			ACCESS_HYBRISA_SUBSTATION_THREE,
			)

		if(ACCESS_LIST_HYBRISA_KMCC_CHIEF_ENGINEER)
			return list(ACCESS_HYBRISA_DYNAGRID_CONTROL,
			ACCESS_HYBRISA_DYNAGRID_TELECOMMS,
			ACCESS_HYBRISA_DYNAGRID_KITCHEN,
			ACCESS_HYBRISA_DEPARTURE,
			ACCESS_HYBRISA_DEPLOYMENT,
			ACCESS_HYBRISA_COMMAND,
			) + get_access(ACCESS_LIST_HYBRISA_KMCC_ENGINEER) + get_access(ACCESS_LIST_HYBRISA_SUBSTATIONS)

		if(ACCESS_LIST_HYBRISA_NSPA_CONSTABLE)
			return list(ACCESS_HYBRISA_NSPA_GENERAL,
			ACCESS_HYBRISA_NSPA_CHECKPOINT,
			ACCESS_HYBRISA_NOVAMEDICA_GENERAL,
			ACCESS_HYBRISA_NOVAMEDICA_MORGUE,
			ACCESS_HYBRISA_NOVAMEDICA_TOWER,
			ACCESS_HYBRISA_DYNAGRID_GENERAL,
			ACCESS_HYBRISA_DEPARTURE,
			ACCESS_HYBRISA_SANITATION,
			ACCESS_HYBRISA_FOYER,
			ACCESS_HYBRISA_WYFOYER,
			ACCESS_HYBRISA_SPACEPORT,
			ACCESS_HYBRISA_ENTERTAINMENT,
			)

		if(ACCESS_LIST_HYBRISA_NSPA_SENIOR_CONSTABLE)
			return list(ACCESS_HYBRISA_NSPA_SECURE,
			ACCESS_HYBRISA_CARGOBAY,
			ACCESS_HYBRISA_STORAGE,
			ACCESS_HYBRISA_PORT_OFFICES,
			) + get_access(ACCESS_LIST_HYBRISA_NSPA_CONSTABLE)

		if(ACCESS_LIST_HYBRISA_NSPA_SERGEANT)
			return list(ACCESS_HYBRISA_NSPA_CRATE,
			ACCESS_HYBRISA_MINING,
			ACCESS_HYBRISA_HIGHMINING,
			ACCESS_HYBRISA_DYNAGRID_CONTROL,
			ACCESS_HYBRISA_DYNAGRID_KITCHEN,
			...
			ACCESS_HYBRISA_MINING_EAST,
			ACCESS_HYBRISA_SANITATION,
			)+ get_access(ACCESS_LIST_HYBRISA_NSPA_SENIOR_CONSTABLE)

		if(ACCESS_LIST_HYBRISA_NSPA_INSPECTOR)
			return list(ACCESS_HYBRISA_NOVAMEDICA_GEAR,
			ACCESS_HYBRISA_DYNAGRID_GEAR,
			ACCESS_HYBRISA_DYNAGRID_TELECOMMS,
			ACCESS_HYBRISA_GARAGE,
			ACCESS_HYBRISA_GARAGE_OFFICE,
			ACCESS_HYBRISA_STARGLIDER,
			ACCESS_HYBRISA_HORIZONRUNNER,
			ACCESS_HYBRISA_WEYMART,
			ACCESS_HYBRISA_WEYMART_MANAGER,
			ACCESS_HYBRISA_MERIDIAN,
			ACCESS_HYBRISA_FACTORY,
			ACCESS_HYBRISA_PIZZA,
			ACCESS_HYBRISA_PIZZA_GARAGE,
			ACCESS_HYBRISA_CUPPA,
			ACCESS_HYBRISA_MAINTS,
			ACCESS_HYBRISA_WYOFFICE,
			ACCESS_HYBRISA_ASSEMBLY,
			ACCESS_HYBRISA_BAR_KITCHEN,
			ACCESS_HYBRISA_CARGO,
			)+ get_access(ACCESS_LIST_HYBRISA_NSPA_SERGEANT) + get_access(ACCESS_LIST_HYBRISA_SUBSTATIONS)

		if(ACCESS_LIST_HYBRISA_WEYMART_MANAGER)
			return list(ACCESS_HYBRISA_WEYMART,
			ACCESS_HYBRISA_WEYMART_MANAGER,
			ACCESS_HYBRISA_WYFOYER,
			ACCESS_HYBRISA_ASSEMBLY,
			ACCESS_HYBRISA_WYOFFICE,
		...
		if(ACCESS_LIST_HYBRISA_PILOT)
			return list(ACCESS_HYBRISA_SPACEPORT,
			ACCESS_HYBRISA_STARGLIDER,
			ACCESS_HYBRISA_PORT_OFFICES,
			ACCESS_HYBRISA_WYFOYER,
			ACCESS_HYBRISA_WYOFFICE,
		...
		if(ACCESS_LIST_HYBRISA_WYOFFICE)
			return list(ACCESS_HYBRISA_WYFOYER,
			ACCESS_HYBRISA_WYOFFICE,
			ACCESS_HYBRISA_ASSEMBLY,
			ACCESS_HYBRISA_CONFERENCE,
			)

		if(ACCESS_LIST_HYBRISA_WYEXECUTIVE)
			return list(ACCESS_HYBRISA_MERIDIAN,
			ACCESS_HYBRISA_WEYMART,
			ACCESS_HYBRISA_CUPPA,
			ACCESS_HYBRISA_SPACEPORT,
			ACCESS_HYBRISA_PORT_OFFICES,
			ACCESS_HYBRISA_DEPARTURE,
			) + get_access(ACCESS_LIST_HYBRISA_WYOFFICE)

		if(ACCESS_LIST_HYBRISA_MERIDIAN_MANAGER)
			return list(ACCESS_HYBRISA_MERIDIAN,
			ACCESS_HYBRISA_FACTORY,
			ACCESS_HYBRISA_MANAGER,
			ACCESS_HYBRISA_MERIDIAN_CAVERNS,
			) + get_access(ACCESS_LIST_HYBRISA_WYOFFICE)

		if(ACCESS_LIST_HYBRISA_SUPERVISOR)
			return list(ACCESS_HYBRISA_NOVAMEDICA_GENERAL,
			ACCESS_HYBRISA_DYNAGRID_GENERAL,
			ACCESS_HYBRISA_DYNAGRID_GENERATORS,
			ACCESS_HYBRISA_DYNAGRID_GEAR,
			ACCESS_HYBRISA_DYNAGRID_CONTROL,
		...
		if(ACCESS_LIST_HYBRISA_MEDICA)
			return list(ACCESS_HYBRISA_NOVAMEDICA_GENERAL,
			ACCESS_HYBRISA_NOVAMEDICA_MORGUE,
			ACCESS_HYBRISA_NOVAMEDICA_TOWER,
			ACCESS_HYBRISA_NOVAMEDICA_GEAR,
			)
