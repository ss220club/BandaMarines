	...
	if(only_leader)
		if(squad_leader)
			if(!squad_leader.stat && squad_leader.client)
				...
				squad_leader.play_screen_text("<span class='langchat' style=font-size:12pt;text-align:center valign='top'><u>[title_text]</u></span><br>" + text, /atom/movable/screen/text/screen_text/command_order, message_color) // SS220 EDIT: font
	else
