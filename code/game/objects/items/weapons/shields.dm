...
/obj/item/weapon/shield/riot/roman
	...
	desc = "Крупный металлический щит, часто используемый отрядами римской тяжелой пехоты. Способен остановить множество снарядов и ударов в ближнем бою. В связи с его большим размером перемещаться с ним становится затруднительно." //SS220 EDIT
