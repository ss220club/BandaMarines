...
/obj/item/weapon/aquilastaff
	name = "Aquila Staff"
	desc = "Большое величественное знамя, которое аквилиферы использовали для воодушевления римских войск. В крайнем случае может послужить дробящим оружием, но его тяжело носить с собой." //SS220 EDIT
