...
/obj/item/book/manual/orbital_cannon_manual
	...
	dat = {"<html>
				...
				<ol>
					<li>Загрузите боеголовку в пусковую кассету орбитальной пушки (требуется подъемник).</li>
					<li>Загрузите необходимое количество твёрдого топлива в пусковую кассету орбитальной пушки <b>(См. консоль орбитальной пушки)</b>.</li>
					<li>Откройте интерфейс консоли орбитальной пушки.</li>
					<li>Загрузите пусковую кассету в пушку.</li>
					<li>Дошлите содержимое пусковой кассеты в патронник пушки. <b>(это нельзя отменить!)</b></li>
					<li>Теперь сотрудники КИК-а могут стрелять из орбитальной пушки с любой консоли наблюдения.</li>
					<li>После выстрела выгрузите пусковую кассету из орбитальной пушки.</li>
					<li>Проверьте пусковую кассету, чтобы убедиться, что она пуста и исправна.</li>
				</ol>

				<h2>Устранение неполадок:</h2>

				<ul>
					<li>Если вы загрузили пусковую кассету с неправильной боевой частью, вы все равно можете выгрузить его содержимое, если оно ещё не было дослано в патронник.</li>
					<li>Если неправильная боеголовка была помещена в патронник, ее можно убрать только выстрелом.</li>
					<li>Если консоль орбитальной пушки сломана, свяжитесь с Высшим командованием ККМП США для получения замены.</li><li>Если консоль орбитальной пушки сломана, свяжитесь с Высшим командованием ККМП для получения замены.</li>
					...
					<li>Если пусковую кассету орбитальной пушки заедает, нанесите смазку на конвейерную ленту.</li>
