...
/obj/item/book/manual/engineering_construction
	...
	desc = "Подробное руководство, включающее серию диаграмм и таблиц, включающая перечень необходимых ресурсов и надлежащих процедур при строительстве, от баррикад до напольной плитки."
	icon_state = "book_engineering"
	item_state = "book_engineering"
	author = "Ассоциация инженеров колониальной морской пехоты"
...
/obj/item/book/manual/barman_recipes
	name = "Записки бармена: Мешаем напитки, смешиваем чувства, растапливаем сердца высшего командования"
