...
/obj/item/book/manual/engineering_construction
	...
	desc = "Подробное руководство, включающее исчерпывающее количесвто диаграмм и таблиц, перечень надлежащих процедури необходимых ресурсов при строительстве любых объектов, от баррикад до напольной плитки."
	icon_state = "book_engineering"
	item_state = "book_engineering"
	author = "Ассоциация инженеров колониальной морской пехоты"
	...
	dat = {"
		...
		<html>
				...
				<ul>
					...
					<li>При отсутсвии питания на консоли орбитальной пушки проверьте АПЦ в помещении консоли.</li>
...
/obj/item/book/manual/barman_recipes
	...
	dat = {"<html>
				...
				Ниже описаны рецепты некоторых популярных напитков.
