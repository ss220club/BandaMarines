...
/obj/item/book/manual/engineering_construction
	...
	desc = "Подробное руководство, содержащее серию диаграмм и таблиц, включающая перечень необходимых ресурсов и надлежащих процедур при строительстве, от баррикад до напольной плитки."
	icon_state = "book_engineering"
	item_state = "book_engineering"
	author = "Ассоциация инженеров колониальной морской пехоты"
...
/obj/item/book/manual/engineering_hacking
	name = "Взломай-ка: Как работают электрические компоненты"
	desc = "Руководство, посвященное 'взлому' шлюзов, торговых автоматов и всего остального, с чем может справиться ваш многофункциональный инструмент."
	icon_state = "book_hacking"
	item_state = "book_hacking"
	author = "Ассоциация инженеров колониальной морской пехоты"
	title = "Взломай-ка: Как работают электрические компоненты"
...
/obj/item/book/manual/ordnance
	...
	desc = "Руководство, содержащее абсурдно подробную информацию о производстве, сборке и обращении со всеми видами взрывных устройств."
	...
	dat = {"
		...
		<body>
		<iframe style="width:100%; height:85vh;" src="https://bm.ss220.club/index.php/%D0%9E%D1%80%D1%83%D0%B6%D0%B5%D0%B9%D0%BD%D1%8B%D0%B9_%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D0%BA" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/comms
	name = "Подпространственные Телекоммуникации И Ты"
	...
	author = "Ассоциация инженеров колониальной морской пехоты"
	title = "Подпространственные Телекоммуникации И Ты"
...
/obj/item/book/manual/reactor
	name = "Правильная Реакция: Шаги по техническому обслуживанию термоядерного реактора S-52"
	desc = "Руководство, содержащее информацию о том, как обслуживать корабельные термоядерные реакторы S-52, очень популярные двигатели среди космических кораблей."
	icon_state = "book_supermatter"
	item_state = "book_supermatter"
	author = "Ассоциация инженеров колониальной морской пехоты"
	title = "Правильная Реакция: Шаги по техническому обслуживанию термоядерного реактора S-52"
...
/obj/item/book/manual/orbital_cannon_manual
	...
	dat = {"
		...
		<body>
		<iframe style="width:100%; height:85vh;" src="https://bm.ss220.club/index.php/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D0%BA_%D0%9E%D0%B1%D1%81%D0%BB%D1%83%D0%B6%D0%B8%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F#%D0%9E%D0%B1%D1%81%D0%BB%D1%83%D0%B6%D0%B8%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5_%D0%BE%D1%80%D0%B1%D0%B8%D1%82%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D1%85_%D0%BF%D1%83%D1%88%D0%B5%D0%BA" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/security_space_law
	...
	desc = "Одна из самых важных книг на борту любого судна колониальной морской пехоты США, или, по крайней мере, именно так вы должны к ней относиться. На страницах книги содержатся рекомендации и процедуры ККМП, касающиеся всевозможных ситуаций."
	icon_state = "book_sop"
	item_state = "book_sop"
...
/obj/item/book/manual/surgery
	...
	desc = "Детализированное справочное руководство по хирургическим процедурам. Для тех моментов, когда вы забыли о каком-либо простом шаге хирургической операции."
	...
	dat = {"
		...
		<body>
		<iframe style="width:100%; height:85vh;" src="https://bm.ss220.club/index.php/%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%BE_%D0%BF%D0%BE_%D1%85%D0%B8%D1%80%D1%83%D1%80%D0%B3%D0%B8%D0%B8" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/medical_diagnostics_manual
	name = "Cправочник «Медицинские основы и практики»"
	...
	title = "Cправочник «Медицинские основы и практики»"
	...
	dat = {"<html>
				...
				<i>Ниже приводится медицинская присяга, которую приносят признанные практикующие врачи, проходящие службу в космосе повсюду, в том числе в военных подразделениях Объединенных Америк.</i><br>
				...
				<ol>
					<li>Теперь как практикующий врач, Я торжественно обещаю, что буду, насколько это в моих силах, служить человечеству, заботясь о больных, укрепляя их здоровье и облегчая боль и страдания.</li>
					...
					<li>Я буду заниматься медицинской практикой добросовестно, со смирением, честностью и состраданием, работая со своими коллегами-практикующими врачами и другими коллегами для удовлетворения потребностей моих пациентов.</li>
					<li>Я никогда намеренно не буду делать или назначать что-либо, что может нанести вред моим пациентам.</li>
					<li>Я не позволю соображениям пола, расы, религии, политической принадлежности, сексуальной ориентации, национальности или социального положения влиять на мои обязанности по уходу.</li>
					...
					<li>Я буду осознавать ограниченность своих знаний и стремиться поддерживать и совершенствовать свое понимание и навыки на протяжении всей своей профессиональной жизни. Я буду признавать и пытаться исправлять свои собственные ошибки, а также честно оценивать ошибки других и реагировать на них.</li>
					<li>Я буду стремиться содействовать распространению медицинских знаний посредством преподавания и научных исследований.</li>
				...
				<h3>Main guide</h3>
				<iframe style="width:100%; height:85vh;" src="https://bm.ss220.club/index.php/%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%BE_%D0%BF%D0%BE_%D0%BC%D0%B5%D0%B4%D0%B8%D1%86%D0%B8%D0%BD%D0%B5" frameborder="0" id="main_frame"></iframe>
				</body>
			</html>
...
/obj/item/book/manual/chemistry
	...
	dat = {"
		...
		<body>
		<iframe style="width:100%; height:85vh;" src="https://bm.ss220.club/index.php/%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%BE_%D0%BF%D0%BE_%D1%85%D0%B8%D0%BC%D0%B8%D0%B8" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/research_and_development
	...
	desc = "Наука: передовой технологии. Эта книга содержит глубоко специализированную и научную информацию о продолжающейся исследовательской миссии ККМП и корпорации 'Вейланд-Ютани': исследовать новые необычные миры; искать новую жизнь, изучать новые сплавы и новые вакцины; смело идти туда, где еще не был ни один ученый, фигурально или метафорически!"
	...
	dat = {"
		...
		<body>
		<iframe style="width:100%; height:85vh;" src="https://bm.ss220.club/index.php/%D0%98%D1%81%D1%81%D0%BB%D0%B5%D0%B4%D0%BE%D0%B2%D0%B0%D1%82%D0%B5%D0%BB%D1%8C" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/paperwork
	...
	desc = "Книга, содержащая всевозможные знания и готовые формуляры для составления важных документов.В этой книге есть все что вам нужно."
	icon_state = "book"
	item_state = "book"
	author = "Верховное командование колониальной морской пехоты"
...
/obj/item/book/manual/rank
	...
	desc = "Эта книга содержит информацию обо всех званиях в колониальной морской пехоте Соединенных Штатов, порядке подчинения этих рангов и структуре внутренних департаментов."
	icon_state = "book"
	item_state = "book"
	author = "Верховное командование колониальной морской пехоты"
	title = "Звания морской пехоты: Перечень рангов, званий и департаментов колониальных морских пехотинцев Соединенных Штатов"
	dat = {"
		...
		<body>
		<iframe style="width:100%; height:85vh;" src="https://bm.ss220.club/index.php/%D0%97%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/barman_recipes
	name = "Записки бармена: Мешаем напитки, смешиваем чувства, растапливаем сердца высшего коммандования"
	desc = "Одна из самых популярных книг по приготовлению напитков во всем мире. Это 39-е издание, впервые опубликованное в 1946 году после окончания Второй мировой войны сэром Хью Фэрфаксом, одним из самых престижных барменов всех времен."
	icon_state = "barbook"
	item_state = "barbook"
	author = "Сэр Хью Фэрфакс, Империя трех миров"
	title = "Записки бармена: Мешаем напитки, смешиваем чувства, расапливаем сердца высшего коммандования"
