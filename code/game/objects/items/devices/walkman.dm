...
/obj/item/device/cassette_tape/pop2/Initialize(mapload, ...)
	. = ..()
	songs = list("side1" = CONFIG_GET(str_list/rainbow_side1), "side2" = CONFIG_GET(str_list/rainbow_side2))
...
/obj/item/device/cassette_tape/pop3/Initialize(mapload, ...)
	. = ..()
	songs = list("side1" = CONFIG_GET(str_list/orange_side1), "side2" = CONFIG_GET(str_list/orange_side2))
...
/obj/item/device/cassette_tape/pop4/Initialize(mapload, ...)
	. = ..()
	songs = list("side1" = CONFIG_GET(str_list/pink_side1), "side2" = CONFIG_GET(str_list/pink_side2))
...
/obj/item/device/cassette_tape/heavymetal/Initialize(mapload, ...)
	. = ..()
	songs = list("side1" = CONFIG_GET(str_list/redblack_side1), "side2" = CONFIG_GET(str_list/redblack_side2))
...
/obj/item/device/cassette_tape/hairmetal/Initialize(mapload, ...)
	. = ..()
	songs = list("side1" = CONFIG_GET(str_list/redstripe_side1), "side2" = CONFIG_GET(str_list/redstripe_side2))
...
/obj/item/device/cassette_tape/indie/Initialize(mapload, ...)
	. = ..()
	songs = list("side1" = CONFIG_GET(str_list/risingsun_side1), "side2" = CONFIG_GET(str_list/risingsun_side2))
...
/obj/item/device/cassette_tape/hiphop/Initialize(mapload, ...)
	. = ..()
	songs = list("side1" = CONFIG_GET(str_list/bluestripe_side1), "side2" = CONFIG_GET(str_list/bluestripe_side2))
...
/obj/item/device/cassette_tape/nam/Initialize(mapload, ...)
	. = ..()
	songs = list("side1" = CONFIG_GET(str_list/green_side1), "side2" = CONFIG_GET(str_list/green_side2))
...
/obj/item/device/cassette_tape/ocean/Initialize(mapload, ...)
	. = ..()
	songs = list("side1" = CONFIG_GET(str_list/ocean_side1), "side2" = CONFIG_GET(str_list/ocean_side2))
