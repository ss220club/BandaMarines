...
/obj/item/clothing/accessory/device/whistle/trench
	...
	desc_lore = "While these trench whistles had fallen out of fashion in favor for the smaller and lighter pea whistles, they are still favored by certain military leaders for their authoritative and distinct sound. It had regained its popularity in recent years during the various campaigns held against the UPP at the tail-end of the Dog War on the year 2162, where such whistles were used to coordinate squad movements and issue audible orders on the battlefield by both sides while under constant, heavy fire. During which most engagements were fielded out in the open, and long-range radio communications relied on vulnerable radio-men, whose equipment had faults within the aging technology most typically due to hostile jamming of the communications network among other issues, which further reinforced the necessity of these whistles."
