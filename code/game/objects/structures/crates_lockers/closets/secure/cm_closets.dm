...
/obj/structure/closet/secure_closet/staff_officer/armory/Initialize()
	. = ..()
	new /obj/item/clothing/head/helmet/marine/MP/SO/xeno(src)
	new /obj/item/clothing/head/helmet/marine/MP/SO(src)
	new /obj/item/clothing/head/helmet/marine/MP/SO(src)
	new /obj/item/clothing/suit/storage/marine/CIC(src)
	new /obj/item/clothing/suit/storage/marine/CIC(src)
	new /obj/item/clothing/suit/storage/marine/MP/SO/xeno(src)
...
/obj/structure/closet/secure_closet/cargotech/Initialize()
	. = ..()
	new /obj/item/clothing/suit/xenos/sentinel(src)
	new /obj/item/clothing/head/xenos/sentinel(src)
