...
/obj/structure/machinery/door/poddoor/proc/pry_open(mob/living/carbon/xenomorph/X, time = 4 SECONDS)
	...
	SPAN_XENONOTICE("You start prying $1 open.", list(declent_ru())), max_distance = 3) // SS220 EDIT ADDICTION
	...
	SPAN_XENONOTICE("You pry open $1.", list(declent_ru())), max_distance = 3) // SS220 EDIT ADDICTION
