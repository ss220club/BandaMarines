...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/vehicle_crew
	...
	listed_products = list(
		...
		list("Штурмовой карабин M4RA", 2, /obj/item/weapon/gun/rifle/m4ra, VENDOR_ITEM_REGULAR),
		list("Помповый дробовик M37A2", 2, /obj/item/weapon/gun/shotgun/pump, VENDOR_ITEM_REGULAR),
		list("Пистолет-пулемёт M39", 2, /obj/item/weapon/gun/smg/m39, VENDOR_ITEM_REGULAR),
		list("Импульсная винтовка M41A MK2", 2, /obj/item/weapon/gun/rifle/m41a, VENDOR_ITEM_REGULAR),

		list("БОЕПРИПАСЫ ДЛЯ ОСНОВНОГО ОРУЖИЯ", -1, null, null),
		list("Коробка для патронов (Картечь)", 6, /obj/item/ammo_magazine/shotgun/buckshot, VENDOR_ITEM_REGULAR),
		list("Коробка для патронов (Флешетты)", 6, /obj/item/ammo_magazine/shotgun/flechette, VENDOR_ITEM_REGULAR),
		list("Коробка для патронов (Пуля)", 6, /obj/item/ammo_magazine/shotgun/slugs, VENDOR_ITEM_REGULAR),
		list("Магазин для M4RA (10x24мм)", 12, /obj/item/ammo_magazine/rifle/m4ra, VENDOR_ITEM_REGULAR),
		list("Магазин для M39 HV (10x20мм)", 12, /obj/item/ammo_magazine/smg/m39, VENDOR_ITEM_REGULAR),
		list("M41A Magazine (10x24mm)", 12, /obj/item/ammo_magazine/rifle, VENDOR_ITEM_REGULAR),

		list("ДОПОЛНИТЕЛЬНОЕ ВООРУЖЕНИЕ", -1, null, null),
		list("Автоматический пистолет M10", 2, /obj/item/weapon/gun/pistol/m10, VENDOR_ITEM_REGULAR),
		list("Боевой пистолет 88 Mod 4", 2, /obj/item/weapon/gun/pistol/mod88, VENDOR_ITEM_REGULAR),
		list("Боевой револьвер M44", 2, /obj/item/weapon/gun/revolver/m44, VENDOR_ITEM_REGULAR),
		list("Служебный пистолет M4A3", 2, /obj/item/weapon/gun/pistol/m4a3, VENDOR_ITEM_REGULAR),
		list("Сигнальная ракетница M82F", 2, /obj/item/weapon/gun/flare, VENDOR_ITEM_REGULAR),
		...
		list("Клип-обойма для М44 (.44)", 10, /obj/item/ammo_magazine/revolver, VENDOR_ITEM_REGULAR),
		list("Магазин для M4A3 (9мм)", 10, /obj/item/ammo_magazine/pistol, VENDOR_ITEM_REGULAR),
		...
		list("Магазин для VP78 (9мм)", 8, /obj/item/ammo_magazine/pistol/vp78, VENDOR_ITEM_REGULAR),
		...
		list("Чехол для мачете", 2, /obj/item/storage/large_holster/machete/full, VENDOR_ITEM_REGULAR)
	)
...
GLOBAL_LIST_INIT(cm_vending_clothing_vehicle_crew, list(
		...
		list("Боевой пистолет 88 Mod 4", 0, /obj/item/weapon/gun/pistol/mod88, MARINE_CAN_BUY_ATTACHMENT, VENDOR_ITEM_REGULAR),
		list("Пистолет VP78", 0, /obj/item/weapon/gun/pistol/vp78, MARINE_CAN_BUY_ATTACHMENT, VENDOR_ITEM_REGULAR),
		...
		list("Граната M40 HEDP (Осколочная)", 10, /obj/item/explosive/grenade/high_explosive, null, VENDOR_ITEM_REGULAR),
		...
		list("Бинокль", 10, /obj/item/device/binoculars, null, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/clothing/vehicle_crew
	name = "\improper Раздатчик экипировки экипажа корабля «КолМорТех»"
