...
GLOBAL_LIST_INIT(cm_vending_vehicle_crew_tank, list(
	...
	list("TOW Launcher", 0, /obj/effect/essentials_set/tank/tow, VEHICLE_SECONDARY_AVAILABLE, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/vehicle_crew
	...
	listed_products = list(
		...
		list("Imperial Lasgun", 2, /obj/item/weapon/gun/rifle/m41a/las, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_vehicle_crew, list(
		...
		list("Lasgun Solid Stock", 10, /obj/item/attachable/stock/rifle/las, null, VENDOR_ITEM_REGULAR),
