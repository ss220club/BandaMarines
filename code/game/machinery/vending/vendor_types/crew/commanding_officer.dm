...
GLOBAL_LIST_INIT(cm_vending_gear_commanding_officer, list(
		...
		list("Магазин для M41A MK1 (10x24мм)", 30, /obj/item/ammo_magazine/rifle/m41aMK1, null, VENDOR_ITEM_RECOMMENDED),
		list("Магазин для M41A MK1 (10x24mm AP)", 40, /obj/item/ammo_magazine/rifle/m41aMK1/ap, null, VENDOR_ITEM_RECOMMENDED),
