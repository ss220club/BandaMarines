...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/pilot_officer
	...
	listed_products = list(
		...
		list("Пистолет-пулемет M39", 4, /obj/item/weapon/gun/smg/m39, VENDOR_ITEM_REGULAR),
		...
		list("Автоматический пистолет M10", 4, /obj/item/weapon/gun/pistol/m10, VENDOR_ITEM_REGULAR),
		...
		list("Сигнальная ракетница M82F", 4, /obj/item/weapon/gun/flare, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_pilot_officer, list(
		...
		list("MK30 Tactical Helmet", 0, /obj/item/clothing/head/helmet/marine/pilot, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_MANDATORY),
		...
		list("BELT (ВЫБЕРИТЕ 2)", 0, null, null, null),
		...
		list("GLASSES (ВЫБЕРИТЕ 1)", 0, null, null, null),
