...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/pilot_officer
	...
	listed_products = list(
		...
		list("Imperial Lasgun", 4, /obj/item/weapon/gun/rifle/m41a/las, VENDOR_ITEM_REGULAR),
		...
		list("M10 HV Magazine (10x20mm-APC)", 12, /obj/item/ammo_magazine/pistol/m10, VENDOR_ITEM_REGULAR),
		list("M10 HV Extended Magazine (10x20mm-APC)", 4, /obj/item/ammo_magazine/pistol/m10/extended, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_pilot_officer, list(
		...
		list("MK30 Tactical Helmet", 0, /obj/item/clothing/head/helmet/marine/pilot/novisor, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_MANDATORY),
		...
		list("BELT (CHOOSE 2)", 0, null, null, null),
		...
		list("M276 M39 Holster Rig", 0, /obj/item/storage/belt/gun/m39, MARINE_CAN_BUY_SECONDARY, VENDOR_ITEM_REGULAR),
		list("M276 M10 Holster Rig", 0, /obj/item/storage/belt/gun/m10, MARINE_CAN_BUY_SECONDARY, VENDOR_ITEM_REGULAR),
		list("M276 General Revolver Holster Rig", 0, /obj/item/storage/belt/gun/m44, MARINE_CAN_BUY_SECONDARY, VENDOR_ITEM_REGULAR),
		list("M276 M82F Holster Rig", 0, /obj/item/storage/belt/gun/flaregun, MARINE_CAN_BUY_SECONDARY, VENDOR_ITEM_REGULAR),
		list("M276 General Pistol Holster Rig", 0, /obj/item/storage/belt/gun/m4a3, MARINE_CAN_BUY_SECONDARY, VENDOR_ITEM_REGULAR),
		...
		list("Suppressor, Compact", 10, /obj/item/attachable/suppressor/sleek, null, VENDOR_ITEM_REGULAR),
		list("Extended Barrel", 10, /obj/item/attachable/extended_barrel, null, VENDOR_ITEM_REGULAR),
		list("Shotgun Choke", 10, /obj/item/attachable/shotgun_choke, null, VENDOR_ITEM_REGULAR),
		list("Recoil Compensator", 10, /obj/item/attachable/compensator, null, VENDOR_ITEM_REGULAR),
		list("Extended Recoil Compensator", 10, /obj/item/attachable/extended_barrel/vented, null, VENDOR_ITEM_REGULAR),
		list("M10 Compensator", 10, /obj/item/attachable/compensator/m10, null, VENDOR_ITEM_REGULAR),

		list("Red-Dot Sight", 10, /obj/item/attachable/reddot, null, VENDOR_ITEM_REGULAR),
		list("S5-Micro Dot Sight", 10, /obj/item/attachable/reddot/small, null, VENDOR_ITEM_REGULAR),
		...
		list("M10 HV Magazine (10x20mm-APC)", 10, /obj/item/ammo_magazine/pistol/m10, null, VENDOR_ITEM_REGULAR),
