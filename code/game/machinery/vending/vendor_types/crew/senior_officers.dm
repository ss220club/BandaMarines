...
GLOBAL_LIST_INIT(cm_vending_clothing_military_police_chief, list(
		...
		list("БРОНЯ (ВОЗЬМИТЕ ВСЁ)", 0, null, null, null),
		...
		list("HANDGUN CASE (ВЫБЕРИТЕ 1)", 0, null, null, null),
...
GLOBAL_LIST_INIT(cm_vending_clothing_chief_engineer, list(
		...
		list("СТАНДАРТНАЯ ЭКИПИРОВКА (ВОЗЬМИТЕ ВСЁ)", 0, null, null, null),
		list("Standard Equipment", 0, list(/obj/item/clothing/gloves/yellow, /obj/item/device/radio/headset/almayer/ce,  /obj/item/clothing/shoes/marine, /obj/item/clothing/glasses/welding, /obj/item/device/working_joe_pda/uscm, /obj/item/weapon/gun/smg/nailgun/compact/tactical, /obj/item/ammo_magazine/smg/nailgun), MARINE_CAN_BUY_SHOES, VENDOR_ITEM_MANDATORY),

		list("UNIFORM (ВЫБЕРИТЕ 1)", 0, null, null, null),
		...
		list("SUIT (ВЫБЕРИТЕ 1)", 0, null, null, null),
		...
		list("Разгрузочная система техника ККМП", 0, /obj/item/storage/backpack/marine/engineerpack, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_REGULAR),
		list("Welding Kit", 0, /obj/item/tool/weldpack, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_REGULAR),

		list("ПОЯС (ВЫБЕРИТЕ 1)", 0, null, null, null),
		list("Пояс строителя", 0, /obj/item/storage/belt/utility/construction, MARINE_CAN_BUY_BELT, VENDOR_ITEM_REGULAR),
		list("Поясная разгрузка G8-A", 0, /obj/item/storage/backpack/general_belt, MARINE_CAN_BUY_BELT, VENDOR_ITEM_REGULAR),
		...
		list("Служебный пистолет M4A3", 0, /obj/item/storage/belt/gun/m4a3/full, MARINE_CAN_BUY_SECONDARY, VENDOR_ITEM_RECOMMENDED),
		...
		list("COMBAT HELMET (ВЫБЕРИТЕ 1)", 0, null, null, null),
		...
		list("ОСНОВНОЕ ВООРУЖЕНИЕ (ВЫБЕРИТЕ 1)", 0, null, null, null),
		list("Помповый дробовик M37A2", 0, /obj/item/storage/box/guncase/pumpshotgun, MARINE_CAN_BUY_ESSENTIALS, VENDOR_ITEM_REGULAR),
		list("Импульсная винтовка M41A MK2", 0, /obj/item/storage/box/guncase/m41a, MARINE_CAN_BUY_ESSENTIALS, VENDOR_ITEM_REGULAR),
		list("Огнемёт M240", 0, /obj/item/storage/box/guncase/flamer, MARINE_CAN_BUY_ESSENTIALS, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_req_officer, list(
		...
		list("Headgear (ВЫБЕРИТЕ 1)", 0, null, null, null),
...
GLOBAL_LIST_INIT(cm_vending_clothing_cmo, list(
		...
		list("EYEWEAR (ВЫБЕРИТЕ 1)", 0, null, null, null),
		...
		list("BAG (ВЫБЕРИТЕ 1)", 0, null, null, null),
		...
		list("Рюкзак санитара", 0, /obj/item/storage/backpack/marine/medic, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_RECOMMENDED),
		...
		list("PERSONAL SIDEARM (ВЫБЕРИТЕ 1)", 0, null, null, null),
		list("Служебный пистолет M4A3", 0, /obj/item/storage/belt/gun/m4a3/full, MARINE_CAN_BUY_SECONDARY, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_gear_xo, list(
		list("CAPTAIN'S PRIMARY (ВЫБЕРИТЕ 1)", 0, null, null, null),
		list("Импульсная винтовка M41A MK1", 0, /obj/item/storage/box/guncase/m41aMK1AP, MARINE_CAN_BUY_KIT, VENDOR_ITEM_MANDATORY),
		...
		list("Магазин для M41A MK1 (10x24мм)", 40, /obj/item/ammo_magazine/rifle/m41aMK1, null, VENDOR_ITEM_RECOMMENDED),
		list("Магазин для M41A MK1 (10x24мм AP)", 60, /obj/item/ammo_magazine/rifle/m41aMK1/ap, null, VENDOR_ITEM_RECOMMENDED),
...
GLOBAL_LIST_INIT(cm_vending_clothing_xo, list(
		...
		list("PERSONAL WEAPON (ВЫБЕРИТЕ 1)", 0, null, null, null),
		list("Пистолет VP78", 0, /obj/item/storage/belt/gun/m4a3/wy/vp78, MARINE_CAN_BUY_SECONDARY, VENDOR_ITEM_RECOMMENDED),
		list("Служебный пистолет M4A3", 0, /obj/item/storage/belt/gun/m4a3/commander, MARINE_CAN_BUY_SECONDARY, VENDOR_ITEM_REGULAR),
		list("Mod 88 Pistol", 0, /obj/item/storage/belt/gun/m4a3/mod88, MARINE_CAN_BUY_SECONDARY, VENDOR_ITEM_REGULAR),
		...
		list("HATS (ВЫБЕРИТЕ 1)", 0, null, null, null),
