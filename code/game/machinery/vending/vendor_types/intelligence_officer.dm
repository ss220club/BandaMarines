...
GLOBAL_LIST_INIT(cm_vending_gear_intelligence_officer, list(
		...
		list("SensorMate Medical Optic", 5, /obj/item/device/helmet_visor/medical, null, VENDOR_ITEM_REGULAR),
		list("Welding Visor", 5, /obj/item/device/helmet_visor/welding_visor, null, VENDOR_ITEM_REGULAR),
		// SS220 EDIT - START
		list("Night Vision Optic", 25, /obj/item/device/helmet_visor/night_vision/normal, null, VENDOR_ITEM_RECOMMENDED),
...
GLOBAL_LIST_INIT(cm_vending_clothing_intelligence_officer, list(
		...
		list("Expedition Satchel", 0, /obj/item/storage/backpack/marine/satchel/intel/expeditionsatchel, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_RECOMMENDED),
...
GLOBAL_LIST_INIT(cm_vending_guns_intelligence_officer, list(
		...
		list("M10 HV Magazine (10x20mm-APC)", 20, /obj/item/ammo_magazine/pistol/m10, VENDOR_ITEM_REGULAR),
		list("M10 HV Extended Magazine (10x20mm-APC)", 8, /obj/item/ammo_magazine/pistol/m10/extended, VENDOR_ITEM_REGULAR),
