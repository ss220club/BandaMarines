...
GLOBAL_LIST_INIT(cm_vending_gear_intelligence_officer, list(
		...
		list("Мотоцикл (Камуфляж)", 0, /obj/vehicle/motorbike/camo, MARINE_CAN_BUY_ATTACHMENT, VENDOR_ITEM_REGULAR),
		list("Коляска мотоцикла (Камуфляж)", 0, /obj/structure/bed/chair/stroller/camo, MARINE_CAN_BUY_ACCESSORY, VENDOR_ITEM_REGULAR),
		// SS220 EDIT - END
	))
