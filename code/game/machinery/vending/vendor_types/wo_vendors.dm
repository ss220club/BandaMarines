...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/wo/populate_product_list(scale)
	listed_products = list(
		...
		list("M10 Helmet Netting", floor(scale * 5), /obj/item/clothing/accessory/helmet/cover/netting, VENDOR_ITEM_REGULAR),
		list("M10 Helmet Rain Cover", floor(scale * 5), /obj/item/clothing/accessory/helmet/cover/raincover, VENDOR_ITEM_REGULAR),
		...
		list("USCM Shoulder Patch", floor(scale * 10), /obj/item/clothing/accessory/patch/uscmpatch, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad_prep/wo/populate_product_list(scale)
	listed_products = list(
		...
		list("Imperial Lasgun", floor(scale * 30), /obj/item/weapon/gun/rifle/m41a/las, VENDOR_ITEM_REGULAR),
		...
		list("Lasgun Power Pack", floor(scale * 25), /obj/item/ammo_magazine/rifle/las, VENDOR_ITEM_REGULAR),
