...
GLOBAL_LIST_INIT(cm_vending_gear_leader, list(
		...
		list("Гранатомет M79", 0, /obj/item/storage/box/guncase/m79, MARINE_CAN_BUY_KIT, VENDOR_ITEM_REGULAR),
		...
		list("Гранатомет M79", 18, /obj/item/storage/box/guncase/m79, null, VENDOR_ITEM_REGULAR),
