...
GLOBAL_LIST_INIT(cm_vending_gear_leader, list(
		...
		list("M85A1 Grenade Launcher", 0, /obj/item/storage/box/guncase/m85a1, MARINE_CAN_BUY_KIT, VENDOR_ITEM_REGULAR),
		...
		list("Insulated Gloves (Black)", 3, /obj/item/clothing/gloves/marine/insulated/black, null, VENDOR_ITEM_REGULAR),
		...
		list("M85A1 Grenade Launcher", 18, /obj/item/storage/box/guncase/m85a1, null, VENDOR_ITEM_REGULAR),
