...
GLOBAL_LIST_INIT(cm_vending_gear_tl, list(
		...
		list("Коляска мотоцикла (Камуфляж)", 5, /obj/structure/bed/chair/sidecar/passenger/camo, CIVILIAN_CAN_BUY_SHOES, VENDOR_ITEM_REGULAR),
		list("Коляска мотоцикла (Камуфляж)", 5, /obj/structure/bed/chair/sidecar/cargo/camo, CIVILIAN_CAN_BUY_SHOES, VENDOR_ITEM_REGULAR),
		// SS220 EDIT - END
	))
