...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad_prep/populate_product_list(scale)
	listed_products = list(
		...
		list("Imperial Lasgun", floor(scale * 15), /obj/item/weapon/gun/rifle/m41a/las, VENDOR_ITEM_RECOMMENDED),
		...
		list("Lasgun Power Pack (10x24mm)", floor(scale * 15), /obj/item/ammo_magazine/rifle/las, VENDOR_ITEM_REGULAR),
		...
		list("Lasgun Folding Stock", floor(scale * 5), /obj/item/attachable/stock/rifle/collapsible/las, VENDOR_ITEM_REGULAR),
		...
		list("Underbarrel Flare Launcher", floor(scale * 10), /obj/item/attachable/attached_gun/flare_launcher, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/squad/populate_product_list(scale)
	listed_products = list(
		...
		list("Lasgun AP Power Pack", floor(scale * 3), /obj/item/ammo_magazine/rifle/ap/las, VENDOR_ITEM_REGULAR),
		...
		list("Lasgun Extended Power Pack", 1.9, /obj/item/ammo_magazine/rifle/extended/las, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/attachments/squad/populate_product_list(scale)
	listed_products = list(
		...
		list("S5-Micro Dot Sight", 6, /obj/item/attachable/reddot/small, VENDOR_ITEM_REGULAR),	// SS220 EDIT - Balance attachments
		...
		list("Micro Laser Sight", 3.5, /obj/item/attachable/lasersight/micro, VENDOR_ITEM_REGULAR),	// SS220 EDIT - Balance attachments
		...
		list("Lasgun Solid Stock", 1.5, /obj/item/attachable/stock/rifle/las, VENDOR_ITEM_REGULAR),
