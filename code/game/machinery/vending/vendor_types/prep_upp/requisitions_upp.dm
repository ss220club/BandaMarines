...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/upp_cargo_guns/populate_product_list(scale)
	listed_products = list(
		...
		list("LPO80 Incinerator Unit", floor(scale * 2), /obj/item/storage/box/guncase/flamer/upp, VENDOR_ITEM_REGULAR),
		...
		list("Black Webbing Vest", floor(scale * 5), /obj/item/clothing/accessory/storage/black_vest, VENDOR_ITEM_REGULAR),
		list("Brown Webbing Vest", floor(scale * 5), /obj/item/clothing/accessory/storage/black_vest/brown_vest, VENDOR_ITEM_REGULAR),
		...
		list("Black Drop Pouch", floor(scale * 5), /obj/item/clothing/accessory/storage/droppouch/black, VENDOR_ITEM_REGULAR),
		list("Black Leg Pouch", floor(scale * 5), /obj/item/clothing/accessory/storage/black_vest/black_leg_pouch, VENDOR_ITEM_REGULAR),
		...
		list("Pyrotechnician ROB-6 fueltank", floor(scale * 2), /obj/item/storage/backpack/marine/engineerpack/flamethrower/kit/upp, VENDOR_ITEM_REGULAR),
		...
		list("Machete Pouch (Full)", 2, /obj/item/storage/pouch/machete/full, VENDOR_ITEM_REGULAR),
		...
		list("Large General Pouch", floor(scale * 2), /obj/item/storage/pouch/general/large, VENDOR_ITEM_REGULAR),
		list("Large Magazine Pouch", floor(scale * 2), /obj/item/storage/pouch/magazine/large, VENDOR_ITEM_REGULAR),
		list("Large Shotgun Shell Pouch", floor(scale * 2), /obj/item/storage/pouch/shotgun/large, VENDOR_ITEM_REGULAR),
		...
		list("JTAC Pamphlet", floor(scale * 2), /obj/item/pamphlet/upgradeable/jtac, VENDOR_ITEM_REGULAR),
		list("Engineering Pamphlet", floor(scale * 2), /obj/item/pamphlet/upgradeable/engineer, VENDOR_ITEM_REGULAR),
		...
		list("M15 Fragmentation Grenade Packet", 2, /obj/item/storage/box/packet/m15, VENDOR_ITEM_REGULAR),
		list("Type 8 WP grenade packet", 4, /obj/item/storage/box/packet/phosphorus/upp, VENDOR_ITEM_REGULAR),
		...
		list("M40 HIDP Grenade Packet", 1, /obj/item/storage/box/packet/incendiary, VENDOR_ITEM_REGULAR),
		...
		list("Box of M94 Marking Flare Packs", 2, /obj/item/ammo_box/magazine/misc/flares, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/upp_cargo_ammo/populate_product_list(scale)
	listed_products = list(
		...
		list("LPO80 Incinerator Tank", floor(scale * 3), /obj/item/ammo_magazine/flamer_tank/upp, VENDOR_ITEM_REGULAR),
		...
		list("Flamer Tank Box (UT-Napthal Fuel x 8)", 1, /obj/item/ammo_box/magazine/flamer/upp, VENDOR_ITEM_REGULAR),
		)
