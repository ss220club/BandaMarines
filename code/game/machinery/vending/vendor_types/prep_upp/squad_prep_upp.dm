...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/upp_squad/populate_product_list(scale)
	listed_products = list(
		...
		list("AK-4047 AP magazine (7.62x39mm)", floor(scale * 4), /obj/item/ammo_magazine/rifle/ak4047/ap, VENDOR_ITEM_REGULAR),
		list("Type 64 Helical AP Magazine (7.62x19mm)", floor(scale * 4), /obj/item/ammo_magazine/smg/bizon/ap, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/upp_squad/populate_product_list(scale)
	listed_products = list(
		...
		list("Multitool", floor(scale * 1), /obj/item/device/multitool/upp, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/attachments/upp_squad/populate_product_list(scale)
	listed_products = list(
		...
		list("Angled Grip", 1.5, /obj/item/attachable/angledgrip, VENDOR_ITEM_REGULAR),
