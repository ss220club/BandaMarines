...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/populate_product_list(scale)
	listed_products = list(
		...
		list("Imperial Lasgun", floor(scale * 60), /obj/item/weapon/gun/rifle/m41a/las, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/populate_product_list(scale)
	listed_products = list(
		...
		list("Lasgun Power Pack", floor(scale * 100), /obj/item/ammo_magazine/rifle/las, VENDOR_ITEM_REGULAR),
		...
		list("Lasgun AP Power Pack", floor(scale * 10), /obj/item/ammo_magazine/rifle/ap/las, VENDOR_ITEM_REGULAR),
		...
		list("Lasgun Extended Power Pack", floor(scale * 8), /obj/item/ammo_magazine/rifle/extended/las, VENDOR_ITEM_REGULAR),
		...
		list("Magazine Box (LAS x 10)", 0, /obj/item/ammo_box/magazine/las, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/attachments/populate_product_list(scale)
	listed_products = list(
		...
		// list("Barrel Charger", 1.5, /obj/item/attachable/heavy_barrel, VENDOR_ITEM_REGULAR), // SS220 EDIT - Balance attachments
		...
		list("Lasgun Solid Stock", 4.5, /obj/item/attachable/stock/rifle/las, VENDOR_ITEM_REGULAR),
		list("Lasgun Folding Stock", 4.5, /obj/item/attachable/stock/rifle/collapsible/las, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad_prep/training/populate_product_list(scale)
	listed_products = list(
		...
		list("Imperial Lasgun", floor(scale * 30), /obj/item/weapon/gun/rifle/m41a, VENDOR_ITEM_RECOMMENDED),
