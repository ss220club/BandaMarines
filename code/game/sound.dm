...
/proc/get_sfx(sound)
	if(istext(sound))
		switch(sound)
			...
			if("male_upp_fragout")
				sound = pick('sound/voice/human_male_grenadethrow_UPP_1.ogg', 'sound/voice/human_male_grenadethrow_UPP_2.ogg', 'sound/voice/human_male_grenadethrow_UPP_3.ogg', 'sound/voice/human_male_grenadethrow_UPP_4.ogg', 'sound/voice/human_male_grenadethrow_UPP_5.ogg')
			if("male_warcry")
			...
			if("male_upp_warcry")
				sound = pick('sound/voice/upp_warcry/warcry_male_1.ogg', 'sound/voice/upp_warcry/warcry_male_2.ogg', 'sound/voice/upp_warcry/warcry_male_3.ogg', 'sound/voice/upp_warcry/warcry_male_4.ogg', 'sound/voice/upp_warcry/warcry_male_5.ogg', 'sound/voice/upp_warcry/warcry_male_6.ogg', 'sound/voice/upp_warcry/warcry_male_7.ogg', 'sound/voice/upp_warcry/warcry_male_8.ogg', 'sound/voice/upp_warcry/warcry_male_9.ogg')
			if("male_preburst")
			...
			if("female_upp_warcry")
				sound = pick('sound/voice/upp_warcry/warcry_female_1.ogg', 'sound/voice/upp_warcry/warcry_female_2.ogg', 'sound/voice/upp_warcry/warcry_female_3.ogg', 'sound/voice/upp_warcry/warcry_female_4.ogg', 'sound/voice/upp_warcry/warcry_female_5.ogg')
			if("female_preburst")
