...
/datum/game_mode/colonialmarines/proc/lore_announcement()
	...
	switch(SSmapping.configs[GROUND_MAP].map_name)
		if(MAP_TYRARGO_RIFT)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(xeno_announcement), "Дети мои. В этом мире бушует великая битва, мире, кишащем носителями, уже готовому к тому, чтобы мы его захватили! Однако эти носители оказывают, хотя и бессмысленное, но яростное сопротивление. Я направила ваш под-улей в этот район, вы создадите здесь мощный форпост, чтобы прикрыть наш западный фланг, пока другой под-улей захватит крепость к востоку от вас, заполненную тысячами носителей!\n\nЧтобы помочь вам, я отправила перед вами легион низших Дронов, они гораздо менее разумны, чем вы, но их будет достаточно, чтобы задержать любых оставшихся враждебных носителей к западу от вас, пока вы не обеспечите себе безопасность.", "everything", QUEEN_MOTHER_ANNOUNCE), 20 SECONDS) //SS220 EDIT
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Алмаер, это пункт эвакуации гражданского населения из музея Тирарго. Мы подвергаемся атаке скопления XX-121, но держимся. На нас надвигаются большие скопления XX-121 с северо-востока, и мы находимся под сильным огнем противника. Наши эвакуационные суда заблокированы дальнобойными ударами Бойлеров, а западные выходы из города слишком опасны для передвижения наземной техники.\nМы просим вас обеспечить безопасность западных подходов - нам нужно подавить силы противника и обеспечить эвакуацию гражданского населения. Прием.", "Эвакуационное подразделение Тирарго, Штаб первого воздушно-кавалерийского", 'sound/AI/commandreport.ogg'), 15 MINUTES) //SS220 EDIT
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(xeno_announcement), "Будьте начеку, дети мои. Я почувствовала, что зловонные канализационные трубы этого так называемого города могут быть затоплены носителями в любой момент, если те восстановят электроснабжение в этом районе. Кнопка для сброса этой гнилой воды находится в металлической конструкции, которую носители называют очистными сооружениями.", "everything", QUEEN_MOTHER_ANNOUNCE), 15 MINUTES) // SS220 EDIT
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Внимание: Анализ планов городской застройки выявил потенциальное тактическое преимущество. В городской очистной станции можно активировать выпускной клапан, который затопит нижние канализационные туннели водой, уничтожив значительное количество ксенобиологических организмов.\n\nОднако для работы этого клапана необходимо отремонтировать специальный ЛКП, расположенный в подземной электроподстанции, расположенной к востоку от подземных очистных сооружений", "ARES 3.2 Strategic Notice", 'sound/AI/commandreport.ogg'), 20 MINUTES) //SS220 EDIT
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Алмаер, мы наблюдаем усиление активности XX-121 на эвакуационном пункте Тирарго. Дополнительные особи приближаются с севера.\n\nВражеские Бойлеры приблизились достаточно близко, чтобы подавить нашу авиационную поддержку, мы перенаправляем танки Лонгстрит для прикрытия наших флангов. Запрашиваем немедленное подавление вражеских сил вблизи нашего местоположения через западный вход в город, прием.", "Эвакуационное подразделение Тирарго, Штаб первого воздушно-кавалерийского", 'sound/AI/commandreport.ogg'), 35 MINUTES) //SS220 EDIT
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Всем подразделениям, всё больше скоплений XX-121 приближается с востока. Мы подвергаемся массированному обстрелу со всех сторон и потеряли половину танков Лонгстрит из-за Крушителей.\n\nУ нас закончились осколочно-фугасные боеприпасы, и нам пришлось перейти на боеприпасы с мягкой головной частью. Мы больше не можем их сдерживать, запрашиваем срочную поддержку у сил Алмаера, прием.", "Эвакуационное подразделение Тирарго, Штаб первого воздушно-кавалерийского", 'sound/AI/commandreport.ogg'), 60 MINUTES) //SS220 EDIT
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Это Тирарго. Ксеносы начали наступление с нашего южного фланга. У нас остался всего один танк. Мы отступаем в центральный коридор и перебросили мирных жителей во внутренний периметр.\n\nСитуация критическая, нас уничтожают. Нам нужна поддержка, прием.", "Эвакуационное подразделение Тирарго, Штаб первого воздушно-кавалерийского", 'sound/AI/commandreport.ogg'), 80 MINUTES) //SS220 EDIT
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Всем подразделениям! Это эвакуационный пункт Тирарго, наше положение критическое. Жуки окружили нас со всех сторон, наша бронетехника уничтожена, и теперь нас прижали вражеские Разорители.\n\nНам срочно нужна огневая поддержка, мы больше не можем удерживать эти позиции.", "Эвакуационное подразделение Тирарго, Штаб первого воздушно-кавалерийского", 'sound/AI/commandreport.ogg'), 100 MINUTES) //SS220 EDIT
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Алмаер! Жуки прорвались во внутренний периметр! Гражданские берут в руки оружие для защиты, но они не обучены.\n\nНас уничтожают, нам нужна огневая поддержка прямо сейчас! Сейчас же, черт возьми!", "Эвакуационное подразделение Тирарго, Штаб первого воздушно-кавалерийского", 'sound/AI/commandreport.ogg'), 120 MINUTES) //SS220 EDIT
		...
		if(MAP_WHITE_ANTRE_RESEARCH_FACILITY)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(venir_announcement), "Внимание всему персоналу Белого Грота! В северном квадранте уже идут испытания улья серии K. Сейчас же мы начинаем вторичные испытания улья Прайм в восточном секторе.\n\nПерсонал восточного сектора, будьте готовы принять грудоломов улья Прайм в свою зону содержания.\n\nКроме того, напоминаем всему персоналу, что подразделение «Лазурь-15» из ЧВК «Белая гвардия» и отряд морской пехоты США находятся в пути для оказания помощи в испытаниях и доставки важного груза. Конец связи.", "Объявление управляющего центра «Белый Грот»", 'sound/AI/commandreport.ogg'), 5 SECONDS) //SS220 EDIT
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(venir_announcement), "Внимание! На объекте произошел масштабный инцидент с нарушением карантинных мер! Инициализирована полная изоляция объекта.", "Объявление управляющего центра «Белый Грот»", 'sound/ambience/containment_breach1.ogg'), 30 SECONDS) //SS220 EDIT
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(venir_announcement), "Внимание! Мы полагаем, что «Лазурь-15» выманила основную часть K-серии за пределы объекта, но у нас происходят масштабные перебои в электроснабжении - зона содержания улья Прайм находится под угрозой. Весь выживший персонал, пригото#^@!&*------", "Объявление управляющего центра «Белый Грот»", 'sound/AI/commandreport.ogg'), 65 SECONDS) //SS220 EDIT
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(venir_announcement), "Нарушение в работе разделяющего заслона улья Прайм неминуема.", "Автоматическая система объявлений комплекса", 'sound/AI/commandreport.ogg'), 165 SECONDS) //SS220 EDIT
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Алмаер, это командир взвода «Лазурь-15». Мы только что получили сигнал бедствия из «Белого Грота». Похоже, происходит масштабное нарушение герметичности, оттуда массово вырываются какие-то желтоватые ксеноморфы. Персонал объекта несёт огромные потери, и мы находимся в невыгодной оборонительной позиции. Мы попытаемся выманить эти ксено-танго с объекта на открытую местность к северу.\n\nКак только мы переместимся к северу от объекта, связь прервётся. Моя рекомендация — отправиться в «Белый Грот» и попытаться спасти оставшихся учёных и захватить то, за чем нас послали. Может быть, заодно спасете и Кадинского, если его ещё не прибили к стене.\n\nСвои позиции мы удержим. «Лазурь-15», конец связи.", "Командир взвода «Лазурь-15»", 'sound/AI/commandreport.ogg'), 4 MINUTES) //SS220 EDIT
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(xeno_lore_announcement), "Что-то происходит... Будьте начеку.", "everything", "Объявление Королевы-матери", 'sound/ambience/containment_breach1.ogg'), 30 SECONDS) //SS220 EDIT
