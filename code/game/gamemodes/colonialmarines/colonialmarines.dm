...
/datum/game_mode/colonialmarines/proc/lore_announcement()
	...
	switch(SSmapping.configs[GROUND_MAP].map_name)
		...
		if(MAP_LV1021_FALCONS_FURY)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Соколы, это Снейк Итерс, ФОРЭКОН. Разведка района проведена. Имеем две пригодные площадки десантирования.\n\nПервая зона высадки — северо-западнее лагеря. Площадка достаточно открытая, с востока протекает река — её придётся форсировать. Все активные силы CLF в районе этой зоны высадки нами устранены.\n\n«Вторая зона высадки — южнее. Расположена на одном берегу с лагерем, имеет более надёжное прикрытие. Но при этом открыта для вклинения противника с западного и восточного направлений.\n\nВнимание: мы также заметили ловушки в подлеске.\n\nУдачи, Пикирующие соколы. Отомстите им за Тайкона.", "Командир взвода Снейк Итерс", 'sound/AI/commandreport.ogg'), 3 MINUTES)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(clf_announcement), "Бойцы, говорит координатор лагеря! Всем вооружиться! Инопланетные твари (жуки) вываливаются из джунглей и только что уничтожили группу, которую я отправил на восток. Связь с нашими бойцами западнее реки потеряна. Бросайте всё, что делаете, и забирайте любое оружие и припасы, которые сможете найти. Мы в осаде! Приготовьтесь защищать лагерь любой ценой!", "Координатор лагеря КОФ", 'sound/AI/commandreport.ogg'), 5 SECONDS)
