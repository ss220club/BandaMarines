...
/datum/game_mode/colonialmarines/proc/lore_announcement()
	...
	switch(SSmapping.configs[GROUND_MAP].map_name)
		if(MAP_TYRARGO_RIFT)
			...
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Алмаер - пункт эвакуации гражданского населения из музея Тирарго. Мы подвергаемся атаке скопления XX-121, но держимся. На нас надвигаются большие скопления XX-121 с северо-востока, и мы находимся под сильным огнём противника. Наши эвакуационные суда заблокированы дальнобойными ударами Бойлеров, западные выходы из города слишком опасны для передвижения наземной техники.\nМы просим вас обеспечить безопасность западных подходов - нам нужно подавить силы противника и эвакуировать гражданское население. Приём.", "Эвакуационное подразделение Тирарго, штаб первого воздушно-кавалерийского.", 'sound/AI/commandreport.ogg'), 15 MINUTES) //SS220 EDIT
