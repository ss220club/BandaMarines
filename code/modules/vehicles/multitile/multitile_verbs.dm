...
/obj/vehicle/multitile/proc/name_vehicle()
	...
	set desc = "Позволяет дать произвольное имя технике. Единоразовое использование. Максимум 28 символов."	//SS220 EDIT
	set category = "Vehicle"
