...
/obj/vehicle/multitile/arc/proc/open_arc_controls_guide()
	...
	3. <b>\"Переключить сенсорную антенну\"</b> - выдвигает или убирает сенсорную антенну ARC. Если выдвинута, то все неизвестные формы жизни в большом радиусе (45) будут видны на тактической карте, однако ARC не сможет передвигаться. В дополнение активирует автоматическая пушка RE700.<br> \
