/datum/prefab_document/wey_yu/liaison/liability/New()
	...
	dat += "<p class='header-title'>Заявление об ответственности</p>"
	...
	dat += "<p>Подпись: <span class=\"paper_field\"></span><br>Подпись представителя: <span class=\"paper_field\"></span><b>Дата:</b> <font face=\"Times New Roman\"><i>[time2text(REALTIMEOFDAY, "Day DD Month [GLOB.game_year]")]</i></font></p>"
	dat += "</div> <!-- /message-body-text -->"
	dat += ""
	dat += "<div class='message-signature-text'>"
	dat += "<p class='disclaimer'>Наша организация не принимает на себя ответственность за содержание этого сообщения или за последствия любых действий, предпринятых на основании предоставленной информации, если эта информация не будет впоследствии подтверждена в письменной форме. Если вы не являетесь предполагаемым получателем, вам сообщается, что раскрытие, копирование, распространение или принятие любых действий, полагаясь на содержание этой информации, строго запрещено.</p>"
	dat += "<p class='disclaimer'>Это сообщение и любые файлы, переданные с ним, являются конфиденциальными и предназначены исключительно для использования лицом или организацией, которым они адресованы. Это сообщение содержит конфиденциальную информацию и предназначено только для адресата. Если вы не являетесь вышеупомянутым адресатом, вы не должны распространять, распределять или копировать это сообщение. Если вы не являетесь предполагаемым получателем, вам сообщается, что раскрытие, копирование, распространение или принятие любых действий, полагаясь на содержание этой информации, строго запрещено.</p>"
