/datum/prefab_document/wey_yu/liaison/liability/New()
	...
	dat += "<p class='disclaimer'>Наша организация не несет никакой ответственности за содержание данного документа или за последствия любых действий, предпринятых на основе содержащейся в нем информации, если только эта информация не будет заверена в письменной форме в дальнейшем.</p>"
