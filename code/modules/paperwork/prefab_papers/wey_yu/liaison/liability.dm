/datum/prefab_document/wey_yu/liaison/liability/New()
	...
	dat += "<p class='header-title'>Заявление об отказе от ответственности </p>"
	...
	dat += "<p>Я, <span class=\"paper_field\"></span>, отказываюсь от всех прав на предъявление претензий или подачу иска в отношении Корпорации Вэйланд-Ютани вследствие любых причин, которые могу возникнуть (или возникли) на объекте <span class=\"paper_field\"></span>. Настоящее соглашение освобождает Корпорацию Вэйланд-Ютани от любой ответственности, сопряженной с травмами, увечьями и/или страховыми выплатами на объекте <span class=\"paper_field\"></span>.</p>"
	dat += "<p>Подпись: <span class=\"paper_field\"></span><br>Подпись представителя Корпорации: <span class=\"paper_field\"></span><br>Дата: <font face=\"Times New Roman\"><i>[time2text(REALTIMEOFDAY, "Day DD Month [GLOB.game_year]")]</i></font></p>"
	dat += "</div> <!-- /message-body-text -->"
	dat += ""
	dat += "<div class='message-signature-text'>"
	dat += "<p class='disclaimer'>Наша организация не несёт никакой ответственности за содержание данного документа или за последствия любых действий, предпринятых на основе содержащейся в нем информации, если только эта информация не будет заверена в письменной форме в дальнейшем.</p>"
