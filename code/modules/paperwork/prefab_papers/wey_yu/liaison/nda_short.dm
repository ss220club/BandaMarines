/datum/prefab_document/wey_yu/liaison/nda_short/New()
	...
	dat += "<p class=\"header-title\">Соглашение о конфиденциальности</p>"
	...
	dat += "<p>Я, <span class=\"paper_field\"></span>, соглашаюсь на Соглашение о конфиденциальности с Корпорацией Уэйланд-Ютани, что никакая информация о событиях, произошедших на объекте, названном <span class=\"paper_field\"></span>,  или любом другом непосредственно поддерживающем его объекте в ближайшем регионе, не будет обнародована. Только квалифицированный корпоративный персонал, чьи личности были подтверждены, получит такую информацию.</p>"
	dat += "<p>"
	...
	dat += "<p class=\"disclaimer\">Наша организация не несет ответственности за содержание этого письма или за последствия любых действий, предпринятых на основании предоставленной информации, если эта информация не была впоследствии подтверждена в письменном виде. Если вы не являетесь предполагаемым получателем, вам сообщается, что раскрытие, копирование, распространение или принятие каких-либо действий на основе содержания этой информации строго запрещено.</p>"
	dat += "<p class=\"disclaimer\">Это сообщение и любые файлы, переданные с ним, являются конфиденциальными и предназначены исключительно для использования лицом или организацией, к которым они адресованы. Это сообщение содержит конфиденциальную информацию и предназначено только для адресата, если вы не являетесь указанным адресатом, вам не следует распространять, распределять или копировать это письмо. Если вы не являетесь предполагаемым получателем, вам сообщается, что раскрытие, копирование, распространение или принятие каких-либо действий на основе содержания этой информации строго запрещено.</p>"
