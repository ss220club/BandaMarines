/datum/prefab_document/wey_yu/liaison/nda_short/New()
	...
	dat += "<p>Я, <span class=\"paper_field\"></span>, соглашаюсь на Соглашение о конфиденциальности с Корпорацией Уэйланд-Ютани, что никакая информация о событиях, произошедших на объекте, названном <span class=\"paper_field\"></span>, и затем на USS Алмаер, не будет обнародована. Только квалифицированный корпоративный персонал, чьи личности были подтверждены, получит такую информацию.</p>"
	dat += "<p>"
