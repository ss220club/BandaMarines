/datum/prefab_document/wey_yu/liaison/preserve_intent/New()
	...
	dat += "<p class=\"header-title\">Заявление о намерении сохранить</p>"
	...
	dat += "<p>Я, <span class=\"paper_field\"></span>, настоящим клянусь и подтверждаю, что буду делать всё возможное для сохранения и защиты целостности и ценности всех корпоративных активов Корпорации Вейланд Ютани (Космической) на поверхности или над поверхностью<span class=\"paper_field\"></span>.</p>"
	...
	dat += "<p class=\"disclaimer\">Наша организация не несёт ответственности за содержание данного сообщения или последствия любых действий, предпринятых на основе предоставленной информации, если эта информация не подтверждена в письменной форме. Если вы не являетесь целевым адресатом, вам запрещено раскрывать, копировать, распространять или предпринимать любые действия, основанные на содержании данной информации.</p>"
	dat += "<p class=\"disclaimer\">Данное сообщение и прилагаемые файлы являются конфиденциальными и предназначены исключительно для использования указанным адресатом. Сообщение содержит конфиденциальную информацию. Если вы не являетесь указанным адресатом, вам запрещено распространять, копировать или использовать данное сообщение. Любые несанкционированные действия с информацией строго запрещены.</p>"
