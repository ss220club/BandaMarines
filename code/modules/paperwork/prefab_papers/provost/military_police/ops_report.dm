/datum/prefab_document/provost/mp/ops_report/New()
	...
	dat += "<p class='header-title'>Отчет об операциях</p>"
	...
	dat += "Получатель: <span class=\"paper_field\"></span><br>"
	...
	dat += "<p class='disclaimer'>Этот документ, а так же все иные переданные с ним данные являются конфиденциальными и предназначены исключительно для использования лицом или организацией, которым они адресованы. Если вы не являетесь ранее упомянутым адресатом, то вы не должны распространять, копировать или предпринимать какие-либо действия, основываясь на информации полученной из данного документа. Не являясь заявленным адресантом, вы уведомлены о последствиях раскрытия, копирования, распространения или предприятия любых иных действий в отношении полученной информациии.</p>"
