/datum/prefab_document/provost/mp/confiscation_receipt/New()
	...
	dat += "<p class=\"header-title\">Квитанция о конфискации военной полицией</p>"
	...
	dat += "<b>Персональные данные задержанного лица:</b><br><span class=\"paper_field\"></span>"
	dat += "<br><br>"
	dat += "<b>Причина задержания:</b><br><span class=\"paper_field\"></span>"
	dat += "<br><br>"
	dat += "<b>Место задержания:</b><br><span class=\"paper_field\"></span>"
	dat += "<br><br>"
	dat += "<b>Конфискат:</b><br><span class=\"paper_field\"></span>"
	dat += "<br><br>"
