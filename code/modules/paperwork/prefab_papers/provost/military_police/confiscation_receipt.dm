/datum/prefab_document/provost/mp/confiscation_receipt/New()
	...
	dat += "<p class=\"header-title\">Квитанция о конфискации военной полиции</p>"
	...
	dat += "<b>Идентификация лица:</b><br><span class=\"paper_field\"></span>"
	dat += "<br><br>"
	dat += "<b>Причина:</b><br><span class=\"paper_field\"></span>"
	dat += "<br><br>"
