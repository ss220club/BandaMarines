/datum/prefab_document/provost/highcom/custody_transfer/New()
	...
	dat += "<p class=\"header-title\">Приказ о передаче под стражу</p>"
	dat += "<p class=\"header-subtitle\">PR238</p>"
	...
	dat += "<p>Следующее послание является приказом о передаче указанного лица (в дальнейшем именуемого ответчиком) в законное заключение третьей стороны (в дальнейшем именуемой хранителем).</p>"
	dat += "<br>"
	...
	dat += "<b>Станция:</b> <span class=\"paper_field\"></span><br><br>"
	dat += "<hr style=\"margin-bottom:-3px; margin-top:3px;\">"
	dat += "<b>Организация, осуществляющая содержание под стражей</b><br>"
	dat += "<b>Название организации:</b> <span class=\"paper_field\"></span><br>"
	dat += "<b>Назначенный представитель:</b> <span class=\"paper_field\"></span><br><br>"
	dat += "<hr style=\"margin-bottom:-3px; margin-top:3px;\">"
	dat += "<b>Причина передачи:</b>"
	dat += "<br><span class=\"paper_field\"></span>"
	dat += "<br><br>"
	dat += "<hr style=\"margin-bottom:-3px; margin-top:3px;\">"
	dat += "<b>Командующий офицер, уполномочивающий передачу</b><br>"
	dat += "<b>Имя:</b> <span class=\"paper_field\"></span><br>"
