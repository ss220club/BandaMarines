/datum/prefab_document/provost/highcom/custody_transfer/New()
	...
	dat += "<p>Данный документ является приказом о передаче под стражу указанного лица (в дальнейшем именуемого обвиняемым) третьей стороне (в дальнейшем именуемой организация-попечитель).</p>"
	dat += "<br>"
	...
	dat += "<b>Объект:</b> <span class=\"paper_field\"></span><br><br>"
	dat += "<hr style=\"margin-bottom:-3px; margin-top:3px;\">"
	dat += "<b>Организация-попечитель</b><br>"
	...
	dat += "<br><br>"
	dat += "<hr style=\"margin-bottom:-3px; margin-top:3px;\">"
	dat += "<b>Уполномоченный Командующий Офицер</b><br>"
	dat += "<b>Имя:</b> <span class=\"paper_field\"></span><br>"
