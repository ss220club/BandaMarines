/datum/prefab_document/provost/highcom/dao_response/New()
	...
	dat += "После получения ответа, содержащего решение офиса Провоста, связанную форму PR301a необходимо обновить, чтобы указать ответ. Если ЗПД одобрен, ответчику должно быть предоставлено решение офиса Провоста при задержании или до него."
	dat += "</p>"
