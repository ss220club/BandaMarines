/datum/prefab_document/provost/highcom/standard/New()
	...
	dat += "<p>"
	dat += "Это сообщение и любые файлы, переданные с ним, являются конфиденциальными и предназначены исключительно для использования лицом или организацией, которым они адресованы. Если вы не являетесь вышеупомянутым адресатом, вы не должны распространять, копировать или делать какие-либо действия, полагаясь на содержание этой информации.<br>"
	dat += "Если вы не являетесь предполагаемым получателем, вам сообщается, что раскрытие, копирование, распространение или любые действия, основанные на содержании этой информации, строго запрещены.<br>"
	dat += "</p>"
