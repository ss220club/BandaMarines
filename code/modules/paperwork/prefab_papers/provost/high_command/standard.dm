/datum/prefab_document/provost/highcom/standard/New()
	...
	dat += "Не являясь заявленным адресантом, вы уведомлены о последствиях раскрытия, копирования, распространения или предприятия иных действий в отношении полученной информациии.<br>"
	dat += "</p>"
