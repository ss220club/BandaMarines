/datum/prefab_document/provost/highcom/standard/New()
	...
	dat += "Не являясь заявленным адресатом, вы уведомлены о последствиях раскрытия, копирования, распространения или предпринятия иных действий в отношении полученной конфиденциальной информациии.<br>"
	dat += "</p>"
