/datum/prefab_document/provost/highcom/standard/New()
	...
	dat += "<p class=\"header-title\">Официальное обращение Главного управления Военной Полиции</p>"
	...
	dat += "<p class=\"subheading\"><b style=\"color:red;\"><u>Только для уполномоченного персонала</u></b></p><br>"
	dat += "<b>Дата:</b> <font face=\"Times New Roman\"><i>[time2text(REALTIMEOFDAY, "Day DD Month [GLOB.game_year]")]</i></font><br>"
	dat += "<b>Индекс:</b> <span class=\"paper_field\"></span><br>"
	dat += "<b>Тема:</b> <span class=\"paper_field\"></span><br>"
	...
	dat += "<p class=\"signature-title\">Отказ от ответственности</p>"
	dat += "<p>"
	dat += "Этот документ, а так же все иные переданные с ним данные являются конфиденциальными и предназначены исключительно для использования лицом или организацией, которым они адресованы. Если вы не являетесь ранее упомянутым адресатом, то вы не должны распространять, копировать или предпринимать какие-либо действия, основываясь на информации полученной из данного документа.<br>"
	dat += "Не являясь заявленным адресантом, вы уведомлены о последствиях раскрытия, копирования, распространения или предпринятия иных действий в отношении полученной конфиденциальной информациии.<br>"
	dat += "</p>"
