/datum/prefab_document/provost/highcom/arrest_warrant/New()
	...
	dat += "<p>Если ответчик не подчинится аресту, ему будут предъявлены дополнительные обвинения в Сопротивлении Аресту и он может столкнуться с дополнительными дисциплинарными мерами во время судебного разбирательства позже.</p>"
