/datum/prefab_document/uscm/highcom/arrest_warrant/New()
	...
	dat += "<b>По приказу Верховного Командования USCM,</b><br><br>"
	dat += "<p>Обвиняемый, указанный в этом документе, должен сдаться в распоряжение Военной полиции по следующим обвинениям:</p>"
	dat += "<p><span class=\"paper_field\"></span></p>"
	dat += "<hr style=\"margin-bottom:-40px; margin-top:-10px;\">"
	dat += "<p>Если обвиняемый не подчинится аресту, ему будут предъявлены дополнительные обвинения в Сопротивлении аресту, и он может столкнуться с дополнительными дисциплинарными мерами в ходе военного суда в более поздний срок.</p>"
	...
	dat += "<hr style=\"margin-bottom:-3px; margin-top:3px;\">"
	dat += "<b>Уполномоченный командир</b><br>"
	dat += "<b>Имя:</b> <span class=\"paper_field\"></span><br>"
