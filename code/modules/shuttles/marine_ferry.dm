...
/datum/shuttle/ferry/marine/proc/long_jump_crash()
	...
	for(var/mob/dead/observer/observer as anything in GLOB.observer_list)
		to_chat(observer, SPAN_DEADSAY(FONT_SIZE_LARGE("The dropship is about to impact $1 $2", list(get_area_name(T_trg), OBSERVER_JMP(observer, T_trg))))) // SS220 EDIT ADDICTION
