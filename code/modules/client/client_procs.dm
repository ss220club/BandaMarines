...
/client/proc/CanLogin()
	...
	if (num2text(byond_build) in GLOB.blacklisted_builds)
		...
		to_chat_immediate(src, SPAN_WARNING(FONT_SIZE_LARGE("BYOND build $1 ($2.$3) has been blacklisted for the following reason: $4.", list(byond_build, byond_version, byond_build, GLOB.blacklisted_builds[num2text(byond_build)])))) // SS220 EDIT ADDICTION
		to_chat_immediate(src, SPAN_WARNING(FONT_SIZE_LARGE("Please download a new version of BYOND. If $1 is the latest (which it shouldn't be), you can go to <a href=$2>BYOND's website</a> to download other versions.", list(byond_build, "https://secure.byond.com/download/build")))) // SS220 EDIT ADDICTION
