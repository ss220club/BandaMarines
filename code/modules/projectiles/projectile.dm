...
/obj/projectile/proc/fire_at(atom/target, atom/firer, atom/shot, range = 30, speed = 1, atom/original_override, randomize_speed = TRUE, gun_damage_mult = 1, projectile_max_range_add = 0, gun_bonus_proj_scatter = 0)
	...
	if(shot)
		permutated |= get_atom_on_turf(shot) //Don't hit the originating object
