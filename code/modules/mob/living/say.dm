GLOBAL_LIST_INIT(department_radio_keys, list(
	...
	":u" = RADIO_CHANNEL_REQ, ".u" = RADIO_CHANNEL_REQ,
	...
	":3" = RADIO_CHANNEL_AKULA,  ".3" = RADIO_CHANNEL_AKULA, "#3" = RADIO_CHANNEL_AKULA,
	":4" = RADIO_CHANNEL_BIZON,  ".4" = RADIO_CHANNEL_BIZON, "#4" = RADIO_CHANNEL_BIZON,
	":5" = RADIO_CHANNEL_CHAYKA, ".5" = RADIO_CHANNEL_CHAYKA, "#5" = RADIO_CHANNEL_CHAYKA,
	":6" = RADIO_CHANNEL_DELFIN, ".6" = RADIO_CHANNEL_DELFIN, "#6" = RADIO_CHANNEL_DELFIN,
	":-" = RADIO_CHANNEL_UPP_GEN, ".-" = RADIO_CHANNEL_UPP_GEN, "#-" = RADIO_CHANNEL_UPP_GEN,
