...
/datum/hive_status/proc/get_xeno_counts()
	...
	var/list/xeno_counts = list(
		...
		list(XENO_CASTE_HIVELORD = 0, XENO_CASTE_BEHEMOTH = 0, XENO_CASTE_BURROWER = 0, XENO_CASTE_CARRIER = 0, XENO_CASTE_LURKER = 0, XENO_CASTE_SPITTER = 0, XENO_CASTE_WARRIOR = 0),
