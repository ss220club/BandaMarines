...
/datum/species/yautja/larva_impregnated(obj/item/alien_embryo/embryo)
	...
	xeno_message(SPAN_XENOANNOUNCE("Улей чувствует, что охотник за головами был инфицирован! Густое смоляное гнездо теперь доступно в списке специальных построек!"),hivenumber = hive.hivenumber)
