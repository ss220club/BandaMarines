...
/obj/structure/machinery/computer/altitude_control_console/process()
	...
	if(GLOB.ship_temp >= OVERHEAT)
		ai_silent_announcement("Внимание: Орбитальная корректировка более не устойчива, осуществляется переход на геосинхронную орбиту до охлаждения двигателя.", ";")
		...
		ai_silent_announcement("Внимание: Выполняется манёвр с высокой перегрузкой.", ";")
	...
	if(GLOB.ship_alt == SHIP_ALT_LOW)
		...
		ai_silent_announcement("Осуществление регулировки высоты.", ";")
