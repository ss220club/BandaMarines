...
/obj/item/map/zenith_temple_map
	name = "\improper Zenith Temple Map"
	desc = "A satellite printout of the Zenith Temple colony on LV-624."
	html_link = "images/6/6f/Zenith_Temple.png"
...
/proc/setup_all_maps()
	return list(
		...
		MAP_LV_624_LAZARUS_LANDING = new /obj/item/map/zenith_temple_map(),
