...
/obj/item/device/assembly/prox_sensor/attack_alien(mob/living/carbon/xenomorph/xeno)
	...
	if(scanning)
		...
		xeno.visible_message(SPAN_XENOWARNING("$1 slashes $2, turning it off!", list(xeno, declent_ru())), SPAN_XENONOTICE("You slash $1, turning it off!", list(declent_ru()))) // SS220 EDIT ADDICTION
		toggle_scan()
