...
/datum/player_action/reset_human_name/act(client/user, mob/target, list/params)
	...
	to_chat(target_mob, FONT_SIZE_HUGE(SPAN_ADMINHELP("Warning: Your name has been reset by $1.", list(user.ckey))))
...
/datum/player_action/ban_human_name/act(client/user, mob/target, list/params)
	...
	to_chat(target, FONT_SIZE_HUGE(SPAN_ADMINHELP("Warning: You were banned from using human names by $1.", list(user.ckey)))) // SS220 EDIT ADDICTION
